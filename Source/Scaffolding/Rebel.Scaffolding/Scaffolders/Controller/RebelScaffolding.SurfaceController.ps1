[T4Scaffolding.ControllerScaffolder("SurfaceController", Description = "Adds an Rebel 5 ASP.NET MVC SurfaceController", SupportsModelType = $true, SupportsDataContextType = $true, SupportsViewScaffolder = $true)][CmdletBinding()]
param(
