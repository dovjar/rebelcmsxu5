[T4Scaffolding.ViewScaffolder("Razor", Description = "Adds an Rebel 5 ASP.NET MVC View or Partial View for using the Razor view engine", IsRazorType = $true, LayoutPageFilter = "*.cshtml|*.cshtml")][CmdletBinding()]
param(        
