[T4Scaffolding.ViewScaffolder("Razor", Description = "Adds an Umbraco 5 ASP.NET MVC Razor view for a SurfaceController", IsRazorType = $true, LayoutPageFilter = "*.cshtml|*.cshtml")][CmdletBinding()]
param(        
