...
Rebel.System.registerNamespace("Rebel.Installer");

(function ($) {

    Rebel.Installer.InstallerUtility = function() {
        ...
        function installProgressCheck(onlyCheck) {	        
                    ...
                    if (r) {
                        ...
                        else
                        {
                            ...
                            if (viewModel.installPercentage() < r.percentage) {
                                ...
                                var updateBar = function() {
                                    if (viewModel.installPercentage() < 100) {
                                        ...
                                        Rebel.Installer.updateProgressBar(viewModel.installPercentage(), "#progressBarInstall");
                                        //recurse randomly
                            ...
                            if (viewModel.installPercentage() >= 100) {
                                ...
                                Rebel.Installer.updateProgressBar(100, "#progressBarInstall");
                                $(".btn-box").show();
                            }  
                        }       
                    }                    
            ...
            if (viewModel.installPercentage() < 40) {
                setTimeout(function() {
                    if (viewModel.installPercentage() < 40) {
                        Rebel.Installer.updateProgressBar(viewModel.dbInstallRetryCount(), "#progressBarInstall");
        ...
        function appRestart(statusCheck) {
            ...
            if (viewModel.appRestartRetryCount() < 90) {
                setTimeout(function() {
                    if (viewModel.appRestartRetryCount() < 90) {
                        Rebel.Installer.updateProgressBar(viewModel.appRestartRetryCount(), "#progressBarRestart");
                    }     
                }, Math.randomRange(1, 400));
            }
