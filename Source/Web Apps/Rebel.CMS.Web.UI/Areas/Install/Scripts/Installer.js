...
(function ($) {
    ...
    $(document).ready(function () {
        Rebel.Installer.init();
      
    });

    Rebel.Installer = function() {
    ...
    function initProgressBar() {
        Rebel.Installer.updateProgressBar(0, '.progress-bar');
    }
    ...
    //                buttonBox.show();
    //            }
    //            else if (selectValNew.indexOf('SQLCE4Rebel') > -1 && !hasEmbeddedDlls) {
    //                jQuery(step1 + ' .embeddedError').show();
    //            }
    //            else if (selectValNew.indexOf('SQLCE4Rebel') > -1) {
