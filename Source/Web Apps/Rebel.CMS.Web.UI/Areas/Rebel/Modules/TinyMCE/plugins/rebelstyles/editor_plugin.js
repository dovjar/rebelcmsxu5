...
(function () {
    ...
    // tinymce.PluginManager.requireLangPack('rebel');

    tinymce.create('tinymce.plugins.RebelStylesPlugin', {
        /**
        ...
        */
        createControl: function (n, cm) {
            ...
            if (n == 'rebelstyles') {
                ...
                var rebelStyles = this.editor.getParam('theme_rebel_styles').split(';');

                var styles = cm.createListBox('rebelstyles', {
                    title: "-- Styles --",
                    onselect: function (v) {
                        if (v == '') {
                ...
                // add styles
                for (var i = 0; i < rebelStyles.length; i++) {
                    if (rebelStyles[i] != '') {
                        var name = rebelStyles[i].substring(0, rebelStyles[i].indexOf("="));
                        var alias = rebelStyles[i].substring(rebelStyles[i].indexOf("=") + 1, rebelStyles[i].length);
    ...
    // Register plugin
    tinymce.PluginManager.add('rebelstyles', tinymce.plugins.RebelStylesPlugin);
})();
