(function ($) {
    tinymce.create('tinymce.plugins.RebelMacroPlugin', {
        ...
        init: function (ed, url) {
            ...
            function getMacroContents($macro) {
                ...
                var _this = this;
                var data = ko.toJSON({
                    currentNodeId: tinyMCE.activeEditor.getParam('rebel_curr_node_id'),
                    macroAlias: macroAlias,
                    macroParams: macroparams
                });
                var ajaxUrl = tinyMCE.activeEditor.getParam('rebel_macro_contents_ajax_url');
            ...
            function onNodeChanged(ed, cm, n) {
                ...
                cm.setActive('rebelmacro', $macroElement.length != 0);
            ...
            ed.addCommand('mceRebelMacro', function () {
                ...
                setTimeout(function () {
                    ...
                    var urlParams = "contentId=" + tinyMCE.activeEditor.getParam('rebel_curr_node_id') + "&";
                    ...
                    var url = tinyMCE.activeEditor.getParam('rebel_mce_controller_paths')['InsertMacro'];
            ...
            // Register buttons
            ed.addButton('rebelmacro', {
                title: 'rebelmacro.desc',
                cmd: 'mceRebelMacro'
            });
    ...
    // Register plugin
    tinymce.PluginManager.add('rebelmacro', tinymce.plugins.RebelMacroPlugin);
})(jQuery);
