...
(function ($, Base) {
    ...
    Rebel.Controls.RebelTabs = Base.extend({
        ...
        activateTab : function ($tabLink) {
            ...
            $(this).trigger("tabChanged.rebelTabs", [args]);
        }
        
    });

    $.fn.rebelTabs = function (o) {
        ///<summary>Jquery method to instantiate rebel tabs</summary>

        return this.each(function () {            
            var tabs = new Rebel.Controls.RebelTabs($.extend({ jqueryElem: $(this) }, o));
            tabs.init();
        });
    };

    $.fn.rebelTabsApi = function() {
        /// <summary>exposes the Rebel Tabs api for the selected object</summary>
        if ($(this).length != 1) {
            throw "RebelTabsApi selector requires that there be exactly one control selected, this selector returns " + $(this).length;
        };
