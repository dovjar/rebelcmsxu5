...
/// <reference path="/Areas/Rebel/Scripts/jquery/jquery.cookies.2.2.0.js" />
/// <reference path="/Areas/Rebel/Scripts/Rebel.System/QueryStrings" />

Rebel.System.registerNamespace("Rebel.System");

(function ($, Base) {

    Rebel.System.NotificationManager = Base.extend({

        //gets the notification id from the query string if there is one
        _getNotificationId: function() {
            return Rebel.System.QueryStringHelper.getQueryStringValue("NotificationId");
        },
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new Rebel.System.NotificationManager();
