...
(function ($, Base) {
    ...
    $.fn.rebelCollapsePanel = function (o) {
        var _opts = $.extend({
            panelSelector: ".box",
        ...
        return $(this).each(function () {
            var pnl = new Rebel.Controls.CollapsePanel($(this), _opts);
        });
    };

    $.fn.rebelCollapsePanelApi = function() {
        ...
        if ($(this).data("api") == null) {
            throw "The matching element had not been bound to an rebelCollapsePanel";
        }
        return $(this).data("api");
    };

    Rebel.Controls.CollapsePanel = Base.extend({
