/// <reference path="/Areas/Rebel/Scripts/Modernizr/modernizr.js" />

//A plugin used to persist tree applications data so that when navigating between applications in Rebel, the tree's state is maintained.
        ...
        _fn: {
            ...
            clearApplicationState: function (app) {
                ...
                if (Modernizr.sessionstorage) {
                    ...
                    // We set a loaded flag rather than just clearing as the RebelApplication does a check to see whether
