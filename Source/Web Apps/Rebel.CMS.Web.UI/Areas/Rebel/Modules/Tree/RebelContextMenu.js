...
(function ($) {
    ...
    $.jstree.plugin("rebelcontextmenu", {
        __init: function () {
            this.data.rebelContextData = {};
            this.get_container()
            ...
            //handle holding down the button to launch the context menu
                .delegate("a", "mousedown.jstree", $.proxy(function (e) {
                    //set the flag
                    this.data.rebelContextData.down = true;
                    var _this = this;
                    //set the timeout
                    setTimeout(function () {
                        if (_this.data.rebelContextData.down) {
                ...
                .delegate("a", "mouseleave.jstree", $.proxy(function (e) {
                    //reset the flag
                    if (this.data.rebelContextData.down) this.data.rebelContextData.down = false;
                }, this))
                .delegate("a", "click.jstree", $.proxy(function (e) {
                    //reset the flag
                    if (this.data.rebelContextData.down)
                        this.data.rebelContextData.down = false;
                }, this))
				.bind("destroy.jstree", $.proxy(function () {
				    if (this.data.rebelcontextmenu) {
				        $.vakata.context.hide();
				    }
				}, this));
            $(document).bind("context_hide.vakata", $.proxy(function () {
                this.data.rebelcontextmenu = false;
            }, this));
        },
        defaults: {
            ...
            items: function () {
                ...
                var currNode = this.data.rebelContextData.currNode;
        ...
        _fn: {
            show_contextmenu: function (obj, x, y) {
                ...
                this.data.rebelContextData.currNode = obj;
                var s = this.get_settings().rebelcontextmenu,
                ...
                this.data.rebelcontextmenu = true;
                ...
                $.vakata.context.cnt.mouseleave(function () {
                    _this.data.rebelContextData.isOver = false;
                    setTimeout(function () {
                        if (!_this.data.rebelContextData.isOver) {
                            _this.data.rebelContextData.isOver = false;
                            $.vakata.context.hide();
                            _this.data.rebelcontextmenu = false;
                        }
                    }, 500);
                });
                $.vakata.context.cnt.mouseenter(function () {
                    _this.data.rebelContextData.isOver = true;
                });
