...
(function ($, Base) {
    ...
    Rebel.Controls.MenuItems = Base.extend(null, {
       
        hostname: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "hostnameUrl");
        },
        
        language: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "languageUrl");
        },

        publish: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "publishUrl");
        },

        sortItems: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "sortUrl");
        },

        createItem: function($treeNode, $menuObj) { 
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "createUrl");
        },

        copyItem: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "copyUrl");
        },

        moveItem: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "moveUrl");
        },

        permissions: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "permissionsUrl");
        },

        publicAccess: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "publicAccessUrl");
        },

        rollback: function($treeNode, $menuObj) {
            Rebel.Controls.MenuItems._changeContentFrame(this, $treeNode, "rollbackUrl");
        },
        ...
        deleteItem: function($treeNode, $menuObj) {
            ...
            //get a reference to the rebel tree api
            var tree = _this.get_container().rebelTreeApi();
                ...
                success: function(r) {
                    ...
                    if (r && r.message == "Success") {
                        ...
                        if (r.notifications) {
                            ...
                            Rebel.System.NotificationManager.getInstance().showNotifications(r.notifications);
                        }                        
                    }
                    else {
        ...
        reloadChildren: function($treeNode, $menuObj) {            
            //get a reference to the rebel tree api
            var tree = this.get_container().rebelTreeApi();
            //refresh the tree
        ...
        _changeContentFrame: function(jsTree, $treeNode, metaDataKey) {
            ...
            var id = $treeNode.attr("id");
            //get a reference to the rebel tree api
            var tree = jsTree.get_container().rebelTreeApi();
            //get the meta data for the node
            var meta = tree.getNodeMetaData($treeNode);
            ...
            Rebel.System.WindowManager.getInstance().contentFrame(meta[metaDataKey]);
