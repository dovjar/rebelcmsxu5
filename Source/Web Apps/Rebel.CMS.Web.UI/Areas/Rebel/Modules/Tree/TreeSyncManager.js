...
/// <reference path="/Areas/Rebel/Scripts/jQuery/jquery.cookies.js" />
/// <reference path="/Areas/Rebel/Scripts/Rebel.System/QueryStrings.js" />

Rebel.System.registerNamespace("Rebel.Controls");

(function ($, Base) {

    Rebel.Controls.TreeSyncManager = Base.extend({
        ...
        _getPathIdFromQueryString: function() {
            ...
            return Rebel.System.QueryStringHelper.getQueryStringValue("path");
        },
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new Rebel.Controls.TreeSyncManager();
