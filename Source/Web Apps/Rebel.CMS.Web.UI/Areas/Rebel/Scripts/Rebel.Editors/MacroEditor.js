...
(function ($, Base) {
    ...
    Rebel.Editors.MacroEditor = Base.extend({
        ...
        constructor: function () {
            ...
            this._macroPropertiesViewModel = $.extend({}, Rebel.System.BaseViewModel, {
            ...
            this._macroParametersViewModel = $.extend({}, Rebel.System.BaseViewModel, {
                parent: this, // Allways set
            ...
            //knockout js view model for managing the macro parameters
            this._createMacroParameterViewModel = $.extend({}, Rebel.System.BaseViewModel, {
                parent: this, // Allways set
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new Rebel.Editors.MacroEditor();
