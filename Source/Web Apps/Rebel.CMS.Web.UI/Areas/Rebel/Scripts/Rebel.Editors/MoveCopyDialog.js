...
(function ($, Base) {
    ...
    Rebel.Editors.MoveCopyDialog = Base.extend({
        ...
        nodeClickHandler: function(e, args) {
            ...
            var _this = Rebel.Editors.MoveCopyDialog.getInstance(); // Have to fetch instance, as nodeClickHandler is called in context of tree node
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new Rebel.Editors.MoveCopyDialog();
