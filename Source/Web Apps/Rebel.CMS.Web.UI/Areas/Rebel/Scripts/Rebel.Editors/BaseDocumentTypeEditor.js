...
(function ($, Base) {
    ...
    Rebel.Editors.BaseDocumentTypeEditor = Base.extend({
        ...
        init: function (o) {
            ...
            $("#tabs").click(function() {
                ...
                if("" + newName + newAlias == "") {
                    $("#newPropertyPanel").rebelCollapsePanelApi().hide();
                }
            });
            ...
            $(".collapse-panel").rebelCollapsePanel({
                collapsed: function () {
            ...
            if (this._opts.showNewProperty) {
                $("#newPropertyPanel").rebelCollapsePanelApi().show();
            }
            ...
            $("#newPropertyPanel input.text-box[id$='_Name']").live("keyup blur", function() {
                ...
                alias.val($(this).val().toRebelAlias());
            });
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new Rebel.Editors.BaseDocumentTypeEditor();
