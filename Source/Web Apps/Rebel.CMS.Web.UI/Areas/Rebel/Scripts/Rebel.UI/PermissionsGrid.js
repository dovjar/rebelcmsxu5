...
(function ($, Base) {
    ...
    Rebel.UI.PermissionsGrid = Base.extend({
        ...
        constructor: function (el, o) {
            ...
            this._viewModel = {
                userGroupPermissionsModel: new Rebel.UI.PermissionsGridUserGroupPermissionsModel(this._opts.userGroupPermissionsModel),
    ...
    // View models
    Rebel.UI.PermissionsGridUserGroupPermissionsModel = function (val) {
        return {
            userGroupId: ko.observable(val.userGroupId),
            userGroupName: ko.observable(val.userGroupName),
            permissions: ko.observableArray(new Rebel.UI.PermissionsGridPermissionStatusModelCollection(val.permissions)),
            allowAll: function () {
    ...
    Rebel.UI.PermissionsGridPermissionStatusModelCollection = function(val) {
        var permissions = [];
        for(var i = 0; i < val.length; i++) {
            permissions.push(new Rebel.UI.PermissionsGridPermissionStatusModel(val[i]));
        }
        return permissions;
    };
    
    Rebel.UI.PermissionsGridPermissionStatusModel = function(val) {
        return {
    ...
    $.fn.permissionsGrid = function(o) {
        ...
        return $(this).each(function() {
            var treePicker = new Rebel.UI.PermissionsGrid(this, _opts);
    ...
    var gridRowTemplate = "<tr data-id=\"${ permissionId }\">\
        <td>\
            ...
            <span data-bind=\"visible: initialStatus != status()\" title=\"Value has changed.\"><img src=\"../../../../areas/rebel/content/images/bullet_error.png\" alt=\"Alert\" /></span>\
        </td>\
