...
(function ($, Base) {
    ...
    Rebel.UI.TreePicker = Base.extend({
        ...
        constructor: function (el, o) {
            ...
            this._viewModel = $.extend({}, Rebel.System.BaseViewModel, {
                ...
                chooseLink: function () {
                    ...
                    if (!_this.parent._isCreated) {
                        $("#" + _this.parent._el.id + "_tree").rebelTreeApi().createJsTree();
            ...
            this._viewModel.selectedText(decodeURIComponent(this._opts.selectedText));
        ...
        nodeClickHandler: function (e, data) {
            ...
            if (data.metaData.OnNodeClickCallback) {
                Rebel.UI.TreePicker._executeFunctionByName(data.metaData.OnNodeClickCallback, window, e, data);
            }
        }
    ...
    $.fn.treePicker = function (o) {
        ...
        return $(this).each(function () {
            var treePicker = new Rebel.UI.TreePicker(this, _opts);
