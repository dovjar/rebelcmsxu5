...
(function ($, Base) {
    ...
    Rebel.PropertyEditors.PropertyEditorManager = Base.extend({
        ...
        registerPropertyEditor: function(propEditor, callBack) {
            ...
            if (this._registeredPropertyEditors[propEditor.id] == undefined) {
                ...
                // Create a context
                var context = new Rebel.PropertyEditors.PropertyEditorContext();
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new Rebel.PropertyEditors.PropertyEditorManager();
    ...
    $(function(){
        $("#editorContent,#tabs").mousedown(function(e){
            Rebel.PropertyEditors.PropertyEditorManager.getInstance().setFocus(e, null);
        });
    });
