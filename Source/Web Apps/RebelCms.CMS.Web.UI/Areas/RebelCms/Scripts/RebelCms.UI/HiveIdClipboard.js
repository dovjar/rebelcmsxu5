...
/// <reference path="/Areas/RebelCms/Scripts/RebelCms.System/BaseViewModel.js" />
...
(function ($) {
    ...
    $(function () {
        ...
        $("span.hive-id").append("<span class='copy-hive-id-wrapper'><a href='javascript:void(0);' class='copy-hive-id' title='Copy to clipboard'><img src='../../../../areas/RebelCms/content/images/clipboard.png' alt='Copy to clipboard' /></a></span>");

        $("span.hive-id a.copy-hive-id").zclip({
            path: '../../../../areas/RebelCms/modules/zclip/ZeroClipboard.swf',
