...
(function ($, Base) {
    ...
    RebelCms.UI.UIPanel = Base.extend({
        ...
        _createPanel: function(context) {
            ...
            for (var i = 0; i < uiElementsCount; i++) {
                ...
                if (uiElement.uIPanelAlias == this.alias) {
                    var uiElementInst = RebelCms.UI.UIElementFactory.getInstance().createUIElement(uiElement);
                    uiElementInst.bind();
    ...
    $.fn.UIPanel = function(alias, defaultUIElements) {
        ...
        return this.each(function() {
            var uiElementPanel = new RebelCms.UI.UIPanel(this, alias, defaultUIElements);
        });
