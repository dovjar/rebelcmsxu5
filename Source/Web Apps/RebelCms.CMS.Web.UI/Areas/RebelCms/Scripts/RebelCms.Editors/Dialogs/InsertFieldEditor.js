...
(function ($, Base) {
    ...
    RebelCms.Editors.InsertFieldEditor = Base.extend({
        ...
        constructor: function () {
            ...
            this._editorViewModel = $.extend({}, RebelCms.System.BaseViewModel, {
                ...
                save: function(e) {
                    ...
                    var snippet = "@RebelCms.Field(\""+ this.selectedField().replace(" - ", "\", \"") +"\"";
                    ...
                    if(this.insertBefore() && this.insertBefore() != "") {
                        snippet += ", insertBefore: \"" + RebelCms.Utils.htmlEncode(this.insertBefore()) + "\"";
                    }
                    
                    if(this.insertAfter() && this.insertAfter() != "") {
                        snippet += ", insertAfter: \"" + RebelCms.Utils.htmlEncode(this.insertAfter()) + "\"";
                    }
                    
                    if(this.selectedCasingType() && this.selectedCasingType() != "" && this.selectedCasingType() != "Unchanged") {
                        snippet += ", casing: global::RebelCms.Cms.Web.RebelCmsRenderItemCaseType." + this.selectedCasingType();
                    }
                    
                    if(this.selectedEncodingType() && this.selectedEncodingType() != "" && this.selectedEncodingType() != "Unchanged") {
                        snippet += ", encoding: global::RebelCms.Cms.Web.RebelCmsRenderItemEncodingType." + this.selectedEncodingType();
                    }
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new RebelCms.Editors.InsertFieldEditor();
