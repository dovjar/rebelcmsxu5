...
(function ($, Base) {
    ...
    RebelCms.Editors.MoveCopyDialog = Base.extend({
        ...
        constructor: function () {
            ...
            this._dialogViewModel = $.extend({}, RebelCms.System.BaseViewModel, {
                ...
                save: function(e) {
                    ...
                    $.post(_this.parent._opts.ajaxUrl, data, function(e) {
                        ...
                        if (RebelCms.System.ValidationHelper.validateJsonResponse(e, "CustomDataValidationRule")) {
                            $(".validation-summary").validationSummaryApi().hideSummary();
                            _this.success(e.success);
                            _this.msgText(e.msg);
                            RebelCms.System.NotificationManager.getInstance().showNotifications(e.notifications);
                            //sync the tree
                            if (e.path) {
        ...
        nodeClickHandler: function(e, args) {
            ...
            var _this = RebelCms.Editors.MoveCopyDialog.getInstance(); // Have to fetch instance, as nodeClickHandler is called in context of tree node
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new RebelCms.Editors.MoveCopyDialog();
