...
(function ($, Base) {
    ...
    RebelCms.Editors.MacroEditor = Base.extend({
        ...
        constructor: function () {
            ...
            this._macroPropertiesViewModel = $.extend({}, RebelCms.System.BaseViewModel, {
            ...
            this._macroParametersViewModel = $.extend({}, RebelCms.System.BaseViewModel, {
                parent: this, // Allways set
            ...
            //knockout js view model for managing the macro parameters
            this._createMacroParameterViewModel = $.extend({}, RebelCms.System.BaseViewModel, {
                parent: this, // Allways set
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new RebelCms.Editors.MacroEditor();
