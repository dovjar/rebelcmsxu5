...
(function ($, Base) {
    ...
    RebelCms.Editors.SearchBox = Base.extend({
        ...
        constructor: function (o) {
            ...
            var acOptions = {
                ...
                select: function(event, ui) {
                    ...
                    var treeApi = $("#" + _this._opts.treeElementId).RebelCmsTreeApi();
    ...
    //jquery plugin
    $.fn.RebelCmsSearchBox = function(o) {
        var _opts = $.extend({
                inputField: $(this)
            }, o);
        return $(this).each(function() {
            var searchBox = new RebelCms.Editors.SearchBox(_opts);
            $(this).data("api", searchBox);
        });
    };

    //jquery api plugin 
    $.fn.RebelCmsSearchBoxApi = function() {
        ...
        if ($(this).data("api") == null) {
            throw "The matching element had not been bound to an RebelCmsSearchBox";
        }
