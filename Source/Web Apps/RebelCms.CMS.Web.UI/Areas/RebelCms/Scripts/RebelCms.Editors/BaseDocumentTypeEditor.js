...
(function ($, Base) {
    ...
    RebelCms.Editors.BaseDocumentTypeEditor = Base.extend({
        ...
        init: function (o) {
            ...
            $("#tabs").click(function() {
                ...
                if("" + newName + newAlias == "") {
                    $("#newPropertyPanel").RebelCmsCollapsePanelApi().hide();
                }
            });
            ...
            $(".collapse-panel").RebelCmsCollapsePanel({
                collapsed: function () {
            ...
            if (this._opts.showNewProperty) {
                $("#newPropertyPanel").RebelCmsCollapsePanelApi().show();
            }
            ...
            $("#newPropertyPanel input.text-box[id$='_Name']").live("keyup blur", function() {
                ...
                alias.val($(this).val().toRebelCmsAlias());
            });
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new RebelCms.Editors.BaseDocumentTypeEditor();
