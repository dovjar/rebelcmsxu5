...
(function ($, Base) {
    ...
    RebelCms.PropertyEditors.PropertyEditorManager = Base.extend({
        ...
        registerPropertyEditor: function(propEditor, callBack) {
            ...
            if (this._registeredPropertyEditors[propEditor.id] == undefined) {
                ...
                // Create a context
                var context = new RebelCms.PropertyEditors.PropertyEditorContext();
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new RebelCms.PropertyEditors.PropertyEditorManager();
    ...
    $(function(){
        $("#editorContent,#tabs").mousedown(function(e){
            RebelCms.PropertyEditors.PropertyEditorManager.getInstance().setFocus(e, null);
        });
    });
