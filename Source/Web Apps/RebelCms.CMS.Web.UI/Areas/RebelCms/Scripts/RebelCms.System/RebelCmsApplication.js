...
(function ($, Base) {
    ...
    $.fn.RebelCmsApplication = function(o) {
        return $(this).each(function() {
            var app = new RebelCms.System.RebelCmsApplication(o);
            $(this).data("api", app);
        });
    };

    $.fn.RebelCmsApplicationApi = function() {
        ...
        if ($(this).data("api") == null) {
            throw "The matching element had not been bound to an RebelCmsApplication";
        }
        return $(this).data("api");
    };

    RebelCms.System.RebelCmsApplication = Base.extend({
        ...
        constructor: function (o) {
            ...
            this._searchBoxApi = this._searchInput.RebelCmsSearchBoxApi();
            ...
            $(this._opts.mainTree).bind("nodeClicked.RebelCmsTree", function(e, args) {
            ...
            $(this._opts.mainTree).bind("appLoaded.RebelCmsTree", function(e, args) {
        ...
        _toggleSearchBox: function($rootNodes, RebelCmsTree) {
            if ($rootNodes.length != 1) {
                this._searchInput.fadeOut(200);
            }
            else {
                var metaData = RebelCmsTree.getNodeMetaData($rootNodes);
        ...
        loadDashboard: function (appAlias) {
            ...
            //show the dashboard
            this._opts.windowMgr.contentFrame(RebelCms.Utils.urlDecode(dashboard));
        },
        ...
        switchApp: function(appAlias) {
            ...
            this._opts.mainTree.loadApp(src, function(data) {
                //need to check the callback to see if its selecting any persisted nodes (this stuff is stored using the RebelCms ApplicationPersistence jstree plugin)
        ...
        detectLoginPage: function(pageHtml) {
            ...
            if (pageHtml.search( /<meta\s+name="RebelCms-page-type"\s+content="RebelCms-login-page"/ ) != -1) {
                return true;
            }
            return false;
        },
        ...
        handleAuthTimeout: function (x, t, e, useModal) {
            ...
            if (this.detectLoginPage(x.responseText)) {
                if (!useModal) {
                    ...
                    RebelCms.System.WindowManager.getInstance().showModal({ id: "login-dialog", isGlobal: true, title: "Login Expired", modalClass: "login", forceContentInIFrame: true, contentUrl: this._opts.loginUrl, showClose: false });   
                }                
                return true;
            }
            return false;
        ...
        handleAjaxException: function(x, t, e) {
            ...
            //so if the responseText has a meta tag: RebelCms-page-type with a value of: RebelCms-login-page we know its the login page                
            if (!this.handleAuthTimeout(x, t, e, true)) {                
                RebelCms.System.WindowManager.getInstance().showModal({ isGlobal: true, title: "Server error", modalClass: "exception", forceContentInIFrame: true, content: x.responseText });
            }
        }
