(function ($) {
    ...
    if (!String.prototype.toRebelCmsAlias) {
        String.prototype.toRebelCmsAlias = function () {
            ///<summary>///<summary>toRebelCmsAlias extension method for string</summary></summary>
