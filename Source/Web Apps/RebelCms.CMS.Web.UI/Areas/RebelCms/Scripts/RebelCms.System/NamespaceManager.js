if (typeof RebelCms == 'undefined') var RebelCms = {};
if (!RebelCms.System) RebelCms.System = {};

//NB: This is not using Base2, as we want to allow everything to hang off RebelCms.System
//    defining a class here would stop us from using it as a namespace
RebelCms.System.registerNamespace = function (namespace) {
    /// <summary>
