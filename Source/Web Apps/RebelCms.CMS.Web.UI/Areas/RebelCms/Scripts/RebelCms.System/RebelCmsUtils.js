...
RebelCms.System.registerNamespace("RebelCms.Utils");

(function ($, Base) {

    RebelCms.Utils = Base.extend(null, {
        ...
        ctrlClick: function(key, callback, args, $validationElement) {
            ...
            $(document).keydown(function(e) {
                ...
                if (e.keyCode == key.charCodeAt(0) && e.ctrlKey) {
                    if (RebelCms.Utils.isJquery($validationElement) && $.validator) {
        ...
        bindShortcuts: function(selector) {
            ...
            $(selector).find("*[data-shortcut]").each(function() {
                ...
                if (parts[0] == "ctrl")
                    RebelCms.Utils.ctrlClick(parts[1], function(e) {
                        $this.trigger(triggerEvent);
                    }, null, $validationSelector);
                else if (parts[0] == "alt")
                    RebelCms.Utils.altClick(parts[1], function(e) {
                        $this.trigger(triggerEvent);
                    }, null, $validationSelector);
                else if (parts[0] != "shift")
                    RebelCms.Utils.shiftClick(parts[1], function(e) {
                        $this.trigger(triggerEvent);
                    }, null, $validationSelector);
                else
