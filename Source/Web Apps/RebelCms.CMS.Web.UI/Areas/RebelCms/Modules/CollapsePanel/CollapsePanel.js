...
(function ($, Base) {
    ...
    $.fn.RebelCmsCollapsePanel = function (o) {
        var _opts = $.extend({
            panelSelector: ".box",
        ...
        return $(this).each(function () {
            var pnl = new RebelCms.Controls.CollapsePanel($(this), _opts);
        });
    };

    $.fn.RebelCmsCollapsePanelApi = function() {
        ...
        if ($(this).data("api") == null) {
            throw "The matching element had not been bound to an RebelCmsCollapsePanel";
        }
        return $(this).data("api");
    };

    RebelCms.Controls.CollapsePanel = Base.extend({
        ...
        show: function () {
            ...
            // add class for styling expanded view
            this._el.addClass("collapse-panel-expanded");

            // set focus to first avaialble form input
            $(":input:enabled:visible:first", this._el).focus();
        },
        ...
        hide: function () {
            ...
            //remove class to revert styling for expanded view
            this._el.removeClass("collapse-panel-expanded");
