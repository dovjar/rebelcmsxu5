...
(function () {
    ...
    // tinymce.PluginManager.requireLangPack('RebelCms');

    tinymce.create('tinymce.plugins.RebelCmsStylesPlugin', {
        /**
        ...
        */
        createControl: function (n, cm) {
            ...
            if (n == 'RebelCmsstyles') {
                ...
                var RebelCmsStyles = this.editor.getParam('theme_RebelCms_styles').split(';');

                var styles = cm.createListBox('RebelCmsstyles', {
                    title: "-- Styles --",
                    onselect: function (v) {
                        if (v == '') {
                ...
                // add styles
                for (var i = 0; i < RebelCmsStyles.length; i++) {
                    if (RebelCmsStyles[i] != '') {
                        var name = RebelCmsStyles[i].substring(0, RebelCmsStyles[i].indexOf("="));
                        var alias = RebelCmsStyles[i].substring(RebelCmsStyles[i].indexOf("=") + 1, RebelCmsStyles[i].length);
    ...
    // Register plugin
    tinymce.PluginManager.add('RebelCmsstyles', tinymce.plugins.RebelCmsStylesPlugin);
})();