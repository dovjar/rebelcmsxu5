(function ($) {
    tinymce.create('tinymce.plugins.RebelCmsMacroPlugin', {
        ...
        init: function (ed, url) {
            ...
            function getMacroContents($macro) {
                ...
                var _this = this;
                var data = ko.toJSON({
                    currentNodeId: tinyMCE.activeEditor.getParam('RebelCms_curr_node_id'),
                    macroAlias: macroAlias,
                    macroParams: macroparams
                });
                var ajaxUrl = tinyMCE.activeEditor.getParam('RebelCms_macro_contents_ajax_url');
            ...
            function onNodeChanged(ed, cm, n) {
                ...
                cm.setActive('RebelCmsmacro', $macroElement.length != 0);
            ...
            ed.addCommand('mceRebelCmsMacro', function () {
                ...
                setTimeout(function () {
                    ...
                    var urlParams = "contentId=" + tinyMCE.activeEditor.getParam('RebelCms_curr_node_id') + "&";
                    ...
                    var url = tinyMCE.activeEditor.getParam('RebelCms_mce_controller_paths')['InsertMacro'];
            ...
            // Register buttons
            ed.addButton('RebelCmsmacro', {
                title: 'RebelCmsmacro.desc',
                cmd: 'mceRebelCmsMacro'
            });
        ...
        getInfo: function () {
            return {
                longname: 'RebelCms Macro Plugin',
                author: 'RebelCms HQ',
    ...
    // Register plugin
    tinymce.PluginManager.add('RebelCmsmacro', tinymce.plugins.RebelCmsMacroPlugin);
})(jQuery);