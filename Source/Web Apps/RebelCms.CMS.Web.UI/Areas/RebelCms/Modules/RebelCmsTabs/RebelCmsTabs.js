...
(function ($, Base) {
    ...
    RebelCms.Controls.RebelCmsTabs = Base.extend({
        ...
        activateTab : function ($tabLink) {
            ...
            $(this).trigger("tabChanged.RebelCmsTabs", [args]);
        }
        
    });

    $.fn.RebelCmsTabs = function (o) {
        ///<summary>Jquery method to instantiate RebelCms tabs</summary>

        return this.each(function () {            
            var tabs = new RebelCms.Controls.RebelCmsTabs($.extend({ jqueryElem: $(this) }, o));
            tabs.init();
        });
    };

    $.fn.RebelCmsTabsApi = function() {
        /// <summary>exposes the RebelCms Tabs api for the selected object</summary>
        if ($(this).length != 1) {
            throw "RebelCmsTabsApi selector requires that there be exactly one control selected, this selector returns " + $(this).length;
        };
