...
/// <reference path="/Areas/RebelCms/Scripts/jquery/jquery.cookies.2.2.0.js" />
/// <reference path="/Areas/RebelCms/Scripts/RebelCms.System/QueryStrings" />

RebelCms.System.registerNamespace("RebelCms.System");

(function ($, Base) {

    RebelCms.System.NotificationManager = Base.extend({

        //gets the notification id from the query string if there is one
        _getNotificationId: function() {
            return RebelCms.System.QueryStringHelper.getQueryStringValue("NotificationId");
        },
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new RebelCms.System.NotificationManager();
