/// <reference path="/Areas/RebelCms/Scripts/Modernizr/modernizr.js" />

//A plugin used to persist tree applications data so that when navigating between applications in RebelCms, the tree's state is maintained.
        ...
        _fn: {
            ...
            clearApplicationState: function (app) {
                ...
                if (Modernizr.sessionstorage) {
                    ...
                    // We set a loaded flag rather than just clearing as the RebelCmsApplication does a check to see whether
