...
/// <reference path="/Areas/RebelCms/Scripts/jQuery/jquery.cookies.js" />
/// <reference path="/Areas/RebelCms/Scripts/RebelCms.System/QueryStrings.js" />

RebelCms.System.registerNamespace("RebelCms.Controls");

(function ($, Base) {

    RebelCms.Controls.TreeSyncManager = Base.extend({
        ...
        _getPathIdFromQueryString: function() {
            ...
            return RebelCms.System.QueryStringHelper.getQueryStringValue("path");
        },
        ...
        getInstance: function () {
            if (this._instance == null)
                this._instance = new RebelCms.Controls.TreeSyncManager();
