...
(function ($) {
    ...
    $.jstree.plugin("RebelCmscontextmenu", {
        __init: function () {
            this.data.RebelCmsContextData = {};
            this.get_container()
            ...
            //handle holding down the button to launch the context menu
                .delegate("a", "mousedown.jstree", $.proxy(function (e) {
                    //set the flag
                    this.data.RebelCmsContextData.down = true;
                    var _this = this;
                    //set the timeout
                    setTimeout(function () {
                        if (_this.data.RebelCmsContextData.down) {
                ...
                .delegate("a", "mouseleave.jstree", $.proxy(function (e) {
                    //reset the flag
                    if (this.data.RebelCmsContextData.down) this.data.RebelCmsContextData.down = false;
                }, this))
                .delegate("a", "click.jstree", $.proxy(function (e) {
                    //reset the flag
                    if (this.data.RebelCmsContextData.down)
                        this.data.RebelCmsContextData.down = false;
                }, this))
				.bind("destroy.jstree", $.proxy(function () {
				    if (this.data.RebelCmscontextmenu) {
				        $.vakata.context.hide();
				    }
				}, this));
            $(document).bind("context_hide.vakata", $.proxy(function () {
                this.data.RebelCmscontextmenu = false;
            }, this));
        },
        defaults: {
            ...
            items: function () {
                ...
                var currNode = this.data.RebelCmsContextData.currNode;
        ...
        _fn: {
            show_contextmenu: function (obj, x, y) {
                ...
                this.data.RebelCmsContextData.currNode = obj;
                var s = this.get_settings().RebelCmscontextmenu,
                ...
                this.data.RebelCmscontextmenu = true;
                ...
                $.vakata.context.cnt.mouseleave(function () {
                    _this.data.RebelCmsContextData.isOver = false;
                    setTimeout(function () {
                        if (!_this.data.RebelCmsContextData.isOver) {
                            _this.data.RebelCmsContextData.isOver = false;
                            $.vakata.context.hide();
                            _this.data.RebelCmscontextmenu = false;
                        }
                    }, 500);
                });
                $.vakata.context.cnt.mouseenter(function () {
                    _this.data.RebelCmsContextData.isOver = true;
                });
