...
(function ($) {
    ...
    $(document).ready(function () {
        RebelCms.Installer.init();
      
    });

    RebelCms.Installer = function() {
    ...
    function initProgressBar() {
        RebelCms.Installer.updateProgressBar(0, '.progress-bar');
    }
    ...
    //                buttonBox.show();
    //            }
    //            else if (selectValNew.indexOf('SQLCE4RebelCms') > -1 && !hasEmbeddedDlls) {
    //                jQuery(step1 + ' .embeddedError').show();
    //            }
    //            else if (selectValNew.indexOf('SQLCE4RebelCms') > -1) {
