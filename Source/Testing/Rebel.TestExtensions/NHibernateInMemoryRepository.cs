...
using HiveReadProvider = Rebel.Framework.Persistence.NHibernate.HiveReadProvider;
using HiveReadWriteProvider = Rebel.Framework.Persistence.NHibernate.HiveReadWriteProvider;
