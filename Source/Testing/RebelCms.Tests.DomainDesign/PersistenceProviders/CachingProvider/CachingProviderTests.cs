...
using RebelCms.Framework.Hive.CachingProvider;
...
using HiveReadWriteProvider = RebelCms.Framework.Hive.CachingProvider.HiveReadWriteProvider;

namespace RebelCms.Tests.DomainDesign.PersistenceProviders.CachingProvider
{
    [TestClass]
