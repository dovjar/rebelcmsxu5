...
using RebelCms.Framework.Persistence.NHibernate.DataManagement.ReadWrite;
...
using Reader = RebelCms.Framework.Persistence.NHibernate.Reader;
using ReadWriter = RebelCms.Framework.Persistence.NHibernate.ReadWriter;
        ...
        public static void MyClassInitialize(TestContext testContext)
        {
            var frameworkContext =
                new FrameworkContext(
                    ConfigurationManager.GetSection("RebelCms.foundation") as IFoundationConfigurationSection);
