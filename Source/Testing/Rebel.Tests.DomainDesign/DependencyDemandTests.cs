...
using Ninject;
using Rebel.Foundation.Extensions;
using Rebel.Framework.DependencyManagement;
using Rebel.Framework.DependencyManagement.Autofac;
using Rebel.Framework.DependencyManagement.Ninject;
using Rebel.Framework.Hive;
using Rebel.Framework.Persistence;
using Rebel.Framework.Persistence.DependencyManagement.DemandBuilders;
