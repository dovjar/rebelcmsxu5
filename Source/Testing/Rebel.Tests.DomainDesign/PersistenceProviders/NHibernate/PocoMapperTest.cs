...
using Rebel.Framework.Persistence.DtoModel;
using Rebel.Framework.Persistence.DtoModel.AutoMapped;
using Rebel.Framework.Persistence.DtoModel.AutoMapped.Versioning;
using PersistenceEntityStatus = Rebel.Framework.Persistence.DtoModel.AutoMapped.PersistenceEntityStatus;
