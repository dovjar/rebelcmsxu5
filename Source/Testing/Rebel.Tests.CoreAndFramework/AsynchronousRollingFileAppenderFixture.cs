...
namespace Rebel.Tests.CoreAndFramework
{
    ...
    [TestFixture]
    public class AsynchronousRollingFileAppenderFixture
    {
        ...
        {
            return string.Format("{0}{1}.log", _fileFolderPath, fileGuid);
        }

        [SetUp]
        public void SetUp()
        {
            _fileFolderPath = Common.MapPathForTest("~/LogTesting/");
