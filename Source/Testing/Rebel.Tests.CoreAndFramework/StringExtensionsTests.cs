...
namespace Rebel.Tests.CoreAndFramework
{
    ...
    public class StringExtensionsTests
    {
        ...
        public void StringExtensions_To_Entity_Alias()
        {
            ...
            var alias1 = name1.ToRebelAlias();
            var alias2 = name2.ToRebelAlias();
            var alias3 = name3.ToRebelAlias();
            var alias4 = name4.ToRebelAlias();
            var alias5 = name5.ToRebelAlias(StringAliasCaseType.PascalCase);
