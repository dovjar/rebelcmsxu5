...
namespace Rebel.Tests.CoreAndFramework.Linq
{
    ...
    public class TypedEntityExpressionConversionFixture : AbstractExpressionConversionFixture<TypedEntity>
    {
        public override IEnumerable<QueryTestDescription<TypedEntity>> GetAdditionalTests()
        {
            ...
            yield return new QueryTestDescription<TypedEntity>(x => x.InnerAttribute<string>("car", "fuel") == "petrol").WithField(new FieldPredicateExpression("car", "fuel", ValuePredicateType.Equal, "petrol"));
        }
        ...
        public override QueryTestDescription<TypedEntity> GetQueryBooleanEquals(string fieldAlias, bool value)
        {
            return new QueryTestDescription<TypedEntity>(x => x.Attribute<bool>(fieldAlias) == value);
        }
        ...
        public override IEnumerable<QueryTestDescription<TypedEntity>> GetQueryByStringAttributeSubFieldEqual(string fieldName, string subFieldName, string value)
        {
            ...
            yield return new QueryTestDescription<TypedEntity>(x => x.InnerAttribute<string>(fieldName, subFieldName) == value);
        }
    }
}
