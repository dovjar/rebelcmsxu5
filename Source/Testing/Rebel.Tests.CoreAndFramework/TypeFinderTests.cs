            ...
            var assemblies = new[]
                {
                    ...
                    typeof(Rebel.Hive.LazyRelation<>).Assembly,
                    typeof(Rebel.Framework.DependencyManagement.AbstractContainerBuilder).Assembly,
                    typeof(Rebel.Framework.Persistence.DefaultAttributeTypeRegistry).Assembly,
                    typeof(Rebel.Framework.Security.FixedPermissionTypes).Assembly
                };
