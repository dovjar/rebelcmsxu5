...
namespace Rebel.Tests.CoreAndFramework.Hive.DefaultProviders.Membership
{
    ...
    //    //    Assert.AreEqual(input.UserName, output.Attributes["UserName".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.ProviderUserKey, output.Attributes["ProviderUserKey".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.Email, output.Attributes["Email".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.PasswordQuestion, output.Attributes["PasswordQuestion".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.Comment, output.Attributes["Comment".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.IsApproved, output.Attributes["IsApproved".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.IsLockedOut, output.Attributes["IsLockedOut".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.LastLockoutDate, output.Attributes["LastLockoutDate".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.CreationDate, output.Attributes["CreationDate".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.LastLoginDate, output.Attributes["LastLoginDate".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.LastActivityDate, output.Attributes["LastActivityDate".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.LastPasswordChangedDate, output.Attributes["LastPasswordChangedDate".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.IsOnline, output.Attributes["IsOnline".ToRebelAlias()].DynamicValue);
    //    //    Assert.AreEqual(input.ProviderName, output.Attributes["ProviderName".ToRebelAlias()].DynamicValue);
    //    //}
    ...
    //        Assert.AreEqual(input.UserName, output.Attribute<string>(MembershipUserSchema.UsernameAlias));
    //        Assert.AreEqual(input.ProviderUserKey, output.Id.Value.Value);
    //        Assert.AreEqual(input.Email, output.Attribute<string>(MembershipUserSchema.EmailAlias));
    //        Assert.AreEqual(input.PasswordQuestion, output.Attribute<string>(MembershipUserSchema.PasswordQuestionAlias));
    //        Assert.AreEqual(input.Comment, output.Attribute<string>(MembershipUserSchema.CommentsAlias));
    //        Assert.AreEqual(input.IsApproved, output.Attribute<bool>(MembershipUserSchema.IsApprovedAlias));
    //        Assert.AreEqual(input.IsLockedOut, output.Attribute<bool>(MembershipUserSchema.IsLockedOutAlias));
    //        Assert.AreEqual(input.LastLockoutDate.ToUniversalTime(), output.Attribute<DateTimeOffset>(MembershipUserSchema.LastLockoutDateAlias).UtcDateTime);
    //        Assert.AreEqual(input.CreationDate.ToUniversalTime(), output.UtcCreated.UtcDateTime);
    //        Assert.AreEqual(input.LastLoginDate.ToUniversalTime(), output.Attribute<DateTimeOffset>(MembershipUserSchema.LastLoginDateAlias).UtcDateTime);
    //        Assert.AreEqual(input.LastActivityDate.ToUniversalTime(), output.Attribute<DateTimeOffset>(MembershipUserSchema.LastActivityDateAlias).UtcDateTime);
    //        Assert.AreEqual(input.LastPasswordChangedDate.ToUniversalTime(), output.Attribute<DateTimeOffset>(MembershipUserSchema.LastPasswordChangeDateAlias).UtcDateTime);
    //        Assert.AreEqual(input.IsOnline, output.Attribute<bool>(MembershipUserSchema.IsOnlineAlias));
