    ...
    public abstract class AbstractProviderTests : AbstractEntityOnlyProviderTests
    {
        ...
        public void Committing_Both_Entity_And_Schema_Results_In_No_Group_Overlap()
        {
            ...
            using (var writer = ProviderSetup.UnitFactory.Create())
            {
                ...
                writer.EntityRepository.Schemas.AddOrUpdate(Rebel.Framework.Security.Model.FixedSchemas.UserProfileSchema);
                writer.EntityRepository.Schemas.AddOrUpdate(Rebel.Framework.Security.Model.FixedSchemas.UserGroup);
                writer.EntityRepository.AddOrUpdate(userProfile);
                writer.EntityRepository.AddOrUpdate(userGroup);
                writer.EntityRepository.AddRelation(Rebel.Framework.Security.Model.FixedHiveIds.UserGroupVirtualRoot,
                                                    userGroup.Id,
        ...
        public void Get_Entity_By_Relation_Type()
        {
            ...
            adminUserGroup.RelationProxies.EnlistParentById(Rebel.Framework.Security.Model.FixedHiveIds.UserGroupVirtualRoot, FixedRelationTypes.DefaultRelationType);
            myUserGroup.RelationProxies.EnlistParentById(Rebel.Framework.Security.Model.FixedHiveIds.UserGroupVirtualRoot, FixedRelationTypes.DefaultRelationType);
