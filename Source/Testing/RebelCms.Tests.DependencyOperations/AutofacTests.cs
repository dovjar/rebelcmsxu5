...
using RebelCms.Tests.DependencyOperations.IoCStubs;

namespace RebelCms.Tests.DependencyOperations
{
    [TestClass]
    public class AutofacTests
    {
        private IContainerBuilder _containerBuilder;
        private RebelCmsFactorySettings _factorySettings;
        ...
        public void TestInitialize()
        {
            ...
            _factorySettings = new RebelCmsFactorySettings();
        }
