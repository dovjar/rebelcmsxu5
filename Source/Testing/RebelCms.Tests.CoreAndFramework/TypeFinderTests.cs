...
using RebelCms.Framework.Persistence.Examine;
            ...
            var assemblies = new[]
                {
                    ...
                    typeof(RebelCms.Hive.LazyRelation<>).Assembly,
                    typeof(RebelCms.Framework.DependencyManagement.AbstractContainerBuilder).Assembly,
                    typeof(FixedIndexedFields).Assembly,
                    typeof(RebelCms.Framework.Persistence.DefaultAttributeTypeRegistry).Assembly,
                    typeof(RebelCms.Framework.Security.FixedPermissionTypes).Assembly
                };
