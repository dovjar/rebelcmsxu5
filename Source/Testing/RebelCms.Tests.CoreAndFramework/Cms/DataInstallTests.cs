...
using RebelCms.Tests.CoreAndFramework.Hive.DefaultProviders.Examine;
using RebelCms.Tests.Extensions;
using RebelCms.Tests.Extensions.Stubs;

namespace RebelCms.Tests.CoreAndFramework.Cms
{
    [TestFixture]
    public class DataInstallTests //: AbstractPartialTrustFixture<DataInstallTests>
    {
            ...
            Action installCallback = null)
        {
            ...
            var appContext = new FakeRebelCmsApplicationContext(hiveManager, false);
