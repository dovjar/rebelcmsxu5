...
namespace RebelCms.Tests.CoreAndFramework
{
    ...
    public class StringExtensionsTests
    {
        ...
        public void StringExtensions_To_Entity_Alias()
        {
            ...
            var alias1 = name1.ToRebelCmsAlias();
            var alias2 = name2.ToRebelCmsAlias();
            var alias3 = name3.ToRebelCmsAlias();
            var alias4 = name4.ToRebelCmsAlias();
            var alias5 = name5.ToRebelCmsAlias(StringAliasCaseType.PascalCase);
