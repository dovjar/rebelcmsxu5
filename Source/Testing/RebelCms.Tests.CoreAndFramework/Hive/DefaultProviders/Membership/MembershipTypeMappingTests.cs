...
using RebelCms.Hive.Providers.Membership.Mapping;
...
namespace RebelCms.Tests.CoreAndFramework.Hive.DefaultProviders.Membership
{
    ...
    public class MembershipTypeMappingTests
    {
        ...
        //    Assert.AreEqual(input.UserName, output.Attributes["UserName".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.ProviderUserKey, output.Attributes["ProviderUserKey".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.Email, output.Attributes["Email".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.PasswordQuestion, output.Attributes["PasswordQuestion".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.Comment, output.Attributes["Comment".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.IsApproved, output.Attributes["IsApproved".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.IsLockedOut, output.Attributes["IsLockedOut".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.LastLockoutDate, output.Attributes["LastLockoutDate".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.CreationDate, output.Attributes["CreationDate".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.LastLoginDate, output.Attributes["LastLoginDate".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.LastActivityDate, output.Attributes["LastActivityDate".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.LastPasswordChangedDate, output.Attributes["LastPasswordChangedDate".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.IsOnline, output.Attributes["IsOnline".ToRebelCmsAlias()].DynamicValue);
        //    Assert.AreEqual(input.ProviderName, output.Attributes["ProviderName".ToRebelCmsAlias()].DynamicValue);
        //}
