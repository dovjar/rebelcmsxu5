...
namespace Rebel.Tests.Cms
{
    ...
    public class CmsMappingTest
    {
        ...
        private FakeRebelApplicationContext _appContext;
        ...
        public void TestInit()
        {
            ...
            _appContext = new FakeRebelApplicationContext(hive, false);
            ...
            _dependencyResolver.GetService(typeof(IRebelApplicationContext)).Returns(_appContext);
        ...
        {
            var input = CreateDocumentTypeEditorModel(MembershipUserSchema.UsernameAlias);
        ...
        //{
        //    var input = CreateDocumentTypeEditorModel(UserProfileSchema.ApplicationsAlias, UserProfileSchema.CommentsAlias, UserProfileSchema.EmailAlias, UserProfileSchema.IsApprovedAlias,
        //        UserProfileSchema.LastActivityDateAlias, UserProfileSchema.LastLoginDateAlias, UserProfileSchema.LastPasswordChangeDateAlias, UserProfileSchema.PasswordAlias,
        //        UserProfileSchema.PasswordAnswerAlias, UserProfileSchema.PasswordQuestionAlias, UserProfileSchema.PasswordSaltAlias, UserProfileSchema.PersistLoginAlias,
        //        UserProfileSchema.SchemaAlias, UserProfileSchema.SessionTimeoutAlias, UserProfileSchema.StartContentHiveIdAlias, UserProfileSchema.StartMediaHiveIdAlias, UserProfileSchema.UsernameAlias);
        //    input.Properties.Single(x => x.Alias == UserProfileSchema.SessionTimeoutAlias).DataType.InternalPropertyEditor = new NumericEditor();            
        ...
        private static void AssertDocumentTypeEditorModelToContentEditorModelBaseTypes(DocumentTypeEditorModel input, BasicContentEditorModel output)
        {
            ...
            Assert.AreNotEqual(input.ModifiedBy, output.ModifiedBy);
        ...
        public void CmsMappping_DataType_To_DataTypeEditorModel()
        {
            ...
            Assert.AreEqual(input.Name, output.Name);
            Assert.AreEqual(input.Alias, output.Alias);
            Assert.AreEqual(input.ModifiedBy, output.ModifiedBy);
            Assert.AreEqual(input.UtcCreated, output.UtcCreated);
            Assert.AreEqual(input.UtcModified, output.UtcModified);
        ...
        public void CmsMapping_DataTypeEditorModel_To_AttributeType(string dataTypeName)
        {
            ...
            //Assert.AreEqual(model.ModifiedBy, attributeDef.ModifiedBy);
        ...
        public void CmsMapping_AttributeType_To_DataTypeEditorModel()
        {
            ...
            //Assert.AreEqual("", dataTypeViewModel.ModifiedBy);            
        }
        ...
        public void CmsMapping_UserGroup_To_UserGroupEditorModel()
        {
            var customAttributes = new[]
                {
                    MembershipUserSchema.UsernameAlias
                };
        ...
        //{
        //    var customAttributes = new[] {UserProfileSchema.ApplicationsAlias, UserProfileSchema.CommentsAlias, UserProfileSchema.EmailAlias, UserProfileSchema.IsApprovedAlias,
        //        UserProfileSchema.LastActivityDateAlias, UserProfileSchema.LastLoginDateAlias, UserProfileSchema.LastPasswordChangeDateAlias, UserProfileSchema.PasswordAlias,
        //        UserProfileSchema.PasswordAnswerAlias, UserProfileSchema.PasswordQuestionAlias, UserProfileSchema.PasswordSaltAlias, UserProfileSchema.PersistLoginAlias,
        //        UserProfileSchema.SchemaAlias, UserProfileSchema.SessionTimeoutAlias, UserProfileSchema.StartContentHiveIdAlias, UserProfileSchema.StartMediaHiveIdAlias, UserProfileSchema.UsernameAlias};
        ...
        //    input.Attributes[UserProfileSchema.EmailAlias].DynamicValue = "test" + Guid.NewGuid();
        //    input.Attributes[UserProfileSchema.EmailAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new MandatoryPropertyEditor().Id.ToString();
            
        //    input.Attributes[UserProfileSchema.IsApprovedAlias].DynamicValue = true.ToString();
        //    input.Attributes[UserProfileSchema.IsApprovedAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new TrueFalseEditor().Id.ToString();
            
        //    input.Attributes[UserProfileSchema.LastActivityDateAlias].DynamicValue = DateTime.Now;
        //    input.Attributes[UserProfileSchema.LastActivityDateAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new DateTimePickerEditor().Id.ToString();

        //    input.Attributes[UserProfileSchema.LastLoginDateAlias].DynamicValue = DateTime.Now;
        //    input.Attributes[UserProfileSchema.LastLoginDateAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new DateTimePickerEditor().Id.ToString();

        //    input.Attributes[UserProfileSchema.LastPasswordChangeDateAlias].DynamicValue = DateTime.Now;
        //    input.Attributes[UserProfileSchema.LastPasswordChangeDateAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new DateTimePickerEditor().Id.ToString();

        //    input.Attributes[UserProfileSchema.PasswordAlias].DynamicValue = "test" + Guid.NewGuid();
        //    input.Attributes[UserProfileSchema.PasswordAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new MandatoryPropertyEditor().Id.ToString();

        //    input.Attributes[UserProfileSchema.SessionTimeoutAlias].DynamicValue = new Random().Next(0, 1000);
        //    input.Attributes[UserProfileSchema.SessionTimeoutAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new NumericEditor().Id.ToString();

        //    input.Attributes[UserProfileSchema.StartContentHiveIdAlias].DynamicValue = new HiveId(Guid.NewGuid()).ToString();
        //    input.Attributes[UserProfileSchema.StartContentHiveIdAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new TreeNodePicker(Enumerable.Empty<Lazy<TreeController, TreeMetadata>>()).Id.ToString();

        //    input.Attributes[UserProfileSchema.StartMediaHiveIdAlias].DynamicValue = new HiveId(Guid.NewGuid()).ToString();
        //    input.Attributes[UserProfileSchema.StartMediaHiveIdAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new TreeNodePicker(Enumerable.Empty<Lazy<TreeController, TreeMetadata>>()).Id.ToString();

        //    input.Attributes[UserProfileSchema.UsernameAlias].DynamicValue = "test" + Guid.NewGuid();
        //    input.Attributes[UserProfileSchema.UsernameAlias].AttributeDefinition.AttributeType.RenderTypeProvider = new MandatoryPropertyEditor().Id.ToString();
        ...
        //    AssertTypedEntityToContentEditorModelMappings(input, output);
        //    Assert.AreEqual(input.Attributes[NodeNameAttributeDefinition.AliasValue].DynamicValue, output.Name);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.EmailAlias].DynamicValue, output.Email);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.IsApprovedAlias].DynamicValue, output.IsApproved.ToString());
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.LastActivityDateAlias].DynamicValue, output.LastActivityDate);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.LastLoginDateAlias].DynamicValue, output.LastLoginDate);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.LastPasswordChangeDateAlias].DynamicValue, output.LastPasswordChangeDate);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.PasswordAlias].DynamicValue, output.Password);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.SessionTimeoutAlias].DynamicValue, output.SessionTimeout);
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.StartContentHiveIdAlias].DynamicValue, output.StartContentHiveId.ToString());
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.StartMediaHiveIdAlias].DynamicValue, output.StartMediaHiveId.ToString());
        //    Assert.AreEqual(input.Attributes[UserProfileSchema.UsernameAlias].DynamicValue, output.Username);
        ...
        private void AssertTypedEntityToContentEditorModelMappings(TypedEntity input, BasicContentEditorModel output)
        {
            ...
            //BUG: mapping for this doesn't exist
            //Assert.AreEqual("", output.ModifiedBy);
            Assert.AreEqual(input.UtcCreated, output.UtcCreated);
            Assert.AreEqual(input.UtcModified, output.UtcModified);
        ...
        public void CmsMapping_UserGroupEditorModel_To_UserGroup()
        {
            ...
            var input = CreateContentEditorModel<UserGroupEditorModel>(NodeNameAttributeDefinition.AliasValue, MembershipUserSchema.UsernameAlias);
            input.UtcModified = DateTime.Now;
            input.UtcCreated = DateTime.Now;
        ...
        //    var input = CreateContentEditorModel<UserEditorModel>(NodeNameAttributeDefinition.AliasValue, UserProfileSchema.ApplicationsAlias, UserProfileSchema.CommentsAlias, UserProfileSchema.EmailAlias, UserProfileSchema.IsApprovedAlias,
        //        UserProfileSchema.LastActivityDateAlias, UserProfileSchema.LastLoginDateAlias, UserProfileSchema.LastPasswordChangeDateAlias, UserProfileSchema.PasswordAlias,
        //        UserProfileSchema.PasswordAnswerAlias, UserProfileSchema.PasswordQuestionAlias, UserProfileSchema.PasswordSaltAlias, UserProfileSchema.PersistLoginAlias,
        //        UserProfileSchema.SchemaAlias, UserProfileSchema.SessionTimeoutAlias, UserProfileSchema.StartContentHiveIdAlias, UserProfileSchema.StartMediaHiveIdAlias, UserProfileSchema.UsernameAlias);
        //    input.UtcModified = DateTime.Now;
        ...
        private static DataTypeEditorModel CreateDataTypeEditorModel()
        {
            ...
            return new DataTypeEditorModel(new HiveId(Guid.NewGuid()))
            {
                ...
                PreValueEditorModel = propertyEditor.CreatePreValueEditorModel(),
                PropertyEditorId = propertyEditor.Id,
                ModifiedBy = "Shannon" + Guid.NewGuid().ToString("N")
            };
        }
            ...
            var d =  new DocumentTypeEditorModel(new HiveId(Guid.NewGuid()))
                {
                    ...
                    ModifiedBy = Guid.NewGuid().ToString("N"),
                    UtcCreated = DateTime.Now,
                    UtcModified = DateTime.Now,
