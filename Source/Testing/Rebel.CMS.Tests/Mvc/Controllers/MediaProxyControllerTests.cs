...
namespace Rebel.Tests.Cms.Mvc.Controllers
{
    ...
    public class MediaProxyControllerTests
    {
        ...
        public void MediaProxyController_Proxy_Returns_File_Content()
        {
            ...
            var result = controller.Proxy("rebelFile", "0A647849-BF5C-413B-9420-7AB4C9521505", 0, "test.jpg");
        ...
        public void MediaProxyController_Proxy_Returns_File_Content_For_Thumbnail()
        {
            ...
            var result = controller.Proxy("rebelFile", "0A647849-BF5C-413B-9420-7AB4C9521505", 100, "test.jpg");
        ...
        public void Initialize()
        {
            ...
            var mediaPickerAttributeDef = new AttributeDefinition("rebelFile", "") { Id = FixedHiveIds.FileUploadAttributeType, AttributeType = mediaPickerAttributeDefType };
