...
using Rebel.Framework.EntityGraph.Domain.Entity.Graph.MetaData;
using Rebel.Framework.EntityGraph.Domain.EntityAdaptors;
using Rebel.TestExtensions;

namespace Rebel.Framework.Tests.EntityGraph.Domain.Entity.Dynamic
{
    [TestClass]
    public class DynamicEntityTest
    {
        class SimpleDocType : IEntityTypeDefinition
        {
            ...
            public Rebel.Framework.EntityGraph.Domain.Entity.Attribution.MetaData.IAttributionSchemaDefinition AttributeSchema
            {
                get;
                set;
            }
            ...
            public Rebel.Framework.EntityGraph.Domain.Entity.Graph.IEntityGraph DescendentEntities
            {
                get;
                set;
            }

            public Rebel.Framework.EntityGraph.Domain.Entity.Graph.IEntityVertex ParentEntity
            {
                get;
                set;
            }

            public Rebel.Framework.EntityGraph.Domain.Entity.Graph.IEntityVertex RootEntity
            {
                get;
                set;
            }
            ...
            public Rebel.Framework.EntityGraph.Domain.Entity.IEntityStatus Status
            {
                get;
                set;
            }
            ...
            public Rebel.Framework.EntityGraph.Domain.Versioning.IRevisionData Revision
            {
                get;
                set;
            }
            ...
            public Rebel.Framework.EntityGraph.Domain.Entity.IEntityPath Path
            {
                get;
                set;
            }
            ...
            public Rebel.Framework.EntityGraph.Domain.Entity.Graph.EntityAssociationCollection AssociatedEntities
            {
                get;
                set;
            }
