...
using Rebel.Tests.DependencyOperations.IoCStubs;

namespace Rebel.Tests.DependencyOperations
{
    [TestClass]
    public class AutofacTests
    {
        private IContainerBuilder _containerBuilder;
        private RebelFactorySettings _factorySettings;
        ...
        public void TestInitialize()
        {
            ...
            _factorySettings = new RebelFactorySettings();
        }
