...
namespace RebelCms.Tests.Cms
{
    ...
    public static class ControllerExtensions
    {
            ...
            where T : Controller
        {
            ...
            //because of how the RebelCmsAuthorizationAttribute works
            ...
            controller.HttpContext.Stub(x => x.User).Return(new FakePrincipal(new RebelCmsBackOfficeIdentity(new FormsAuthenticationTicket(4, userName, DateTime.Now, DateTime.Now.AddDays(1), false, (new JavaScriptSerializer()).Serialize(userData))), userRoles));
