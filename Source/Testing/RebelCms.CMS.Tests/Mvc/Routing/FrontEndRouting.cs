...
namespace RebelCms.Tests.Cms.Mvc.Routing
{
    ...
    public class FrontEndRouting : RoutingTest
    {
        ...
        /// <summary>
        /// Test RebelCms front-end routable paths
        /// </summary>
        [TestCase("~/", "/")]
        ...
        [Test]
        [Category(TestOwner.CmsFrontend)]
        public void FrontEndRouting_RebelCms_Pages(string routeUrl, string matchUrl)
        {            
            ...
            RouteTable.Routes.GetDataForRoute(routeUrl).ShouldMapTo<RebelCmsController>(x => x.Index((IRebelCmsRenderModel)null));
        }
        ...
        [Test]
        [Category(TestOwner.CmsFrontend)]
        public void FrontEndRouting_Non_RebelCms_Pages(string url)
        {
            var route = RouteTable.Routes.GetDataForRoute(url);
            
            Assert.AreNotEqual("RebelCms", route.Values["controller"].ToString());
        }

        /// <summary>
        /// Test for an RebelCms route that has a user defined controller
        /// </summary>
        [Test]
        [Category(TestOwner.CmsFrontend)]
        public void FrontEndRouting_RebelCms_Route_User_Defined_Controller()
        {
            ...
            content.ContentType = new EntitySchema("customRebelCms");
            ...
            Assert.AreEqual("CustomRebelCms", data.Values["controller"].ToString());
            Assert.AreEqual("Index", data.Values["action"].ToString());
        }

        /// <summary>
        /// Test for an RebelCms route that has a user defined controller and action
        /// </summary>
        [Test]
        [Category(TestOwner.CmsFrontend)]
        public void FrontEndRouting_RebelCms_Route_User_Defined_Controller_Action()
        {
        ...
        /// <summary>
        /// Used to test a user route (non-RebelCms)
        /// </summary>
        ...
        /// <summary>
        /// Used to test a user route RebelCms route
        /// </summary>
        private class CustomRebelCmsController : RebelCmsController
        {
            
            public ActionResult HomePage(IRebelCmsRenderModel model)
            {
                return View();
            }
