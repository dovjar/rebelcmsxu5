...
namespace RebelCms.Tests.Cms
{
    ...
    public class CmsMappingTest
    {
        ...
        private FakeRebelCmsApplicationContext _appContext;
        ...
        public void TestInit()
        {
            ...
            _appContext = new FakeRebelCmsApplicationContext(hive, false);
            ...
            _dependencyResolver.GetService(typeof(IRebelCmsApplicationContext)).Returns(_appContext);
