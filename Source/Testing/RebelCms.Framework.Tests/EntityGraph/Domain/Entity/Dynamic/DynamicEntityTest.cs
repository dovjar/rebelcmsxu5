...
namespace RebelCms.Framework.Tests.EntityGraph.Domain.Entity.Dynamic
{
    [TestClass]
    public class DynamicEntityTest
    {
        class SimpleDocType : IEntityTypeDefinition
        {
            ...
            public RebelCms.Framework.EntityGraph.Domain.Entity.Attribution.MetaData.IAttributionSchemaDefinition AttributeSchema
            {
                get;
                set;
            }
            ...
            public RebelCms.Framework.EntityGraph.Domain.Entity.Graph.IEntityGraph DescendentEntities
            {
                get;
                set;
            }

            public RebelCms.Framework.EntityGraph.Domain.Entity.Graph.IEntityVertex ParentEntity
            {
                get;
                set;
            }

            public RebelCms.Framework.EntityGraph.Domain.Entity.Graph.IEntityVertex RootEntity
            {
                get;
                set;
            }
            ...
            public RebelCms.Framework.EntityGraph.Domain.Entity.IEntityStatus Status
            {
                get;
                set;
            }
            ...
            public RebelCms.Framework.EntityGraph.Domain.Versioning.IRevisionData Revision
            {
                get;
                set;
            }
            ...
            public RebelCms.Framework.EntityGraph.Domain.Entity.IEntityPath Path
            {
                get;
                set;
            }
            ...
            public RebelCms.Framework.EntityGraph.Domain.Entity.Graph.EntityAssociationCollection AssociatedEntities
            {
                get;
                set;
            }
