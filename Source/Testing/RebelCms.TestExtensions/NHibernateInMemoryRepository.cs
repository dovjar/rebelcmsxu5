...
using HiveReadProvider = RebelCms.Framework.Persistence.NHibernate.HiveReadProvider;
using HiveReadWriteProvider = RebelCms.Framework.Persistence.NHibernate.HiveReadWriteProvider;
