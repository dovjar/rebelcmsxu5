...
Upgrade notice:
If you are upgrading from an earlier version of Umbraco a backup of your web.config file is placed in the root of your projects directory. A backup of the umbraco specific config files found in 
App_Data\Umbraco\Config has also been made, so if you have added any entries to these files please make sure to copy them back.
...
Please make sure to check http://umbraco.codeplex.com for release notes.
