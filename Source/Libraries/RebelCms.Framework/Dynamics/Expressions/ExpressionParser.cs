...
namespace RebelCms.Framework.Dynamics.Expressions
{
    public class ExpressionParser
    {
            ...
            Type signatures, string opName, ref Expression left, ref Expression right, int errorPos)
        {
            ...
            // Start RebelCms mod: If this is a dynamic member, wrap the expression in a cast so that the types are equal
