...
namespace RebelCms.Framework
{
    ...
    public struct HiveId : IEquatable<HiveId>
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Guid"/> to <see cref="RebelCms.Framework.HiveId"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Int32"/> to <see cref="RebelCms.Framework.HiveId"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        /// <remarks></remarks>
