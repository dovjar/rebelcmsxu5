...
namespace RebelCms.Framework.Localization.Web.Mvc
{
    /// <summary>
    ...
    /// - Namespace part after the assembly's default namespace . Class name . Property name (e.g. the property "Name" of the class "RebelCms.Framework.Web.Models.CoreEntityModel" becomes Models.CoreEntityModel.Name)
