...
(function () {
    ...
    var ns = this;
    var parts = ["RebelCms", "Framework", "Localization"];
    ...
    //  Frame bubbling? The script file has to be included anyway. 
    //  TODO: Provide way to include just this script to avoid loading it all
    //    var p = window;
    //    do {
    //        if (p.RebelCms &&
    //            p.RebelCms.Framework &&
    //            p.RebelCms.Localization &&
    //            p.RebelCms.Localization.TextManager) {

    //            ns.TextManager = p.RebelCms.Localization.TextManager;
