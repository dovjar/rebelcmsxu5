...
using RebelCms.Framework.Localization.Processing;
...
using RebelCms.Framework.Localization.Web.JavaScript.FormatGroupExpanders;
using RebelCms.Framework.Localization.Web.JavaScript.ParameterEvaluators;
using RebelCms.Framework.Localization.Web.JavaScript.SwitchConditions;
using RebelCms.Framework.Localization.Web.JavaScript.ValueFormatters;

[assembly: WebResource("RebelCms.Framework.Localization.Web.JavaScript.Resources.Localization.js", "text/javascript")]
[assembly: WebResource("RebelCms.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxGlobalization.js", "text/javascript")]
[assembly: WebResource("RebelCms.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxCore.js", "text/javascript")]
...
namespace RebelCms.Framework.Localization.Web.JavaScript
{
    ...
    {        
        ...
        public static IEnumerable<Tuple<Type, string>> ScriptResourceDependencies
        {
            get
            {
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "RebelCms.Framework.Localization.Web.JavaScript.Resources.Localization.js");
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "RebelCms.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxCore.js");
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "RebelCms.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxGlobalization.js");
            }
        }
        ...
        {            
            ...
            output.Write("=new RebelCms.Framework.Localization.TextManager(");
