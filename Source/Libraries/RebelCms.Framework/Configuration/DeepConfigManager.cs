...
namespace RebelCms.Framework.Configuration
{
    ...
    public class DeepConfigManager
    {
        ...
        /// <code>
        /// var myValue = DeepConfigManager.Default.GetFirstWebSetting&lt;FoundationConfigurationSection, string&gt;("RebelCms.foundation", x => x.FoundationSettings.ApplicationTierAlias, "~/App_Plugins");
        /// </code>
        /// This will first scan the ~/App_Plugins folder recursively to find configuraiton settings called 'RebelCms.foundation' that are readable as <see cref="FoundationConfigurationSection"/>,
