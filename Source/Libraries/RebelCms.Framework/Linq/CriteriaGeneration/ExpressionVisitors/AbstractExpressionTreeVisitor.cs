namespace RebelCms.Framework.Linq.CriteriaGeneration.ExpressionVisitors
{
    using System;
    ...
    public abstract class AbstractExpressionTreeVisitor : ThrowingExpressionTreeVisitor
    {
        ...
        protected override Expression VisitBinaryExpression(BinaryExpression expression)
        {
            ...
            //if (RebelCmsExpressionRewriter.IsConvertibleBinary(expression))
            //    return RebelCmsExpressionRewriter.ConvertToFieldEvaluationExpression(expression);
