namespace Rebel.Framework.Persistence.NHibernate.Linq
{
    using System;
    ...
    public class NhCriteriaVisitor : AbstractCriteriaVisitor<ICriterion>
    {
        private NhSessionHelper _activeSession;

        public NhCriteriaVisitor(NhSessionHelper activeSession)
        {
        ...
        {
            internal FilterResult(QueryOver<NodeVersion> subquery, string[] requiredSchemaAliases, Guid[] requiredNodeIds)
            {
                Subquery = subquery;
            ...
            public QueryOver<NodeVersion> Subquery { get; protected set; }
        ...
        private FilterResult GenerateQueryOver(ICriterion fromCriterion, Guid[] nodeIds = null)
        {
            ...
            var query = QueryOver.Of(() => version)
            ...
            switch (node.NodeType)
            {
                ...
                case ExpressionType.AndAlso:
                    ...
                    var combined = new Conjunction()
                        .Add(Subqueries.PropertyIn(Projections.Property<NodeVersion>(x => x.Id).PropertyName,
