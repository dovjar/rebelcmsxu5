...
namespace Rebel.Framework.Persistence.NHibernate.Config
{
    public class ProviderConfigurationSection : AbstractProviderConfigurationSection
    {
        ...
        internal const string XAutoUpdateSchema = "autoUpdateSchema";
        ...
        [ConfigurationProperty(XAutoUpdateSchema, DefaultValue = true)]
        public bool AutoUpdateDbSchema
        {
            get { return (bool)this[XAutoUpdateSchema]; }

            set { this[XAutoUpdateSchema] = value; }
        }
