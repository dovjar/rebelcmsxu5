...
namespace RebelCms.Framework.Persistence.Examine
{
    /// <summary>
    /// Custom indexer for RebelCms
    /// </summary>
    public class RebelCmsExamineIndexer : LuceneIndexer
    {
        /// <summary>
        /// Default constructor for use with provider implementation
        /// </summary>
        public RebelCmsExamineIndexer()
        {
        }
        ...
        /// </param>
        public RebelCmsExamineIndexer(IEnumerable<IndexSet> indexSetConfig)
            : base(indexSetConfig)
        {
        }
        ...
        public RebelCmsExamineIndexer(DirectoryInfo workingFolder, Analyzer analyzer, SynchronizationType synchronizationType)
        ...
        public RebelCmsExamineIndexer(Analyzer analyzer, SynchronizationType synchronizationType, Lucene.Net.Store.Directory luceneDirectory)
            : base(analyzer, synchronizationType, luceneDirectory)
        {
        }

        /// <summary>
        /// A type that defines the type of index for each RebelCms field (non user defined fields)
        /// Alot of standard RebelCms fields shouldn't be tokenized or even indexed, just stored into lucene
