...
namespace RebelCms.Framework.Persistence.Examine.Config
{
    /// <summary>
    /// Defines the Examine searchers/indexers/index set to be used for the RebelCms internal searching
    /// </summary>
