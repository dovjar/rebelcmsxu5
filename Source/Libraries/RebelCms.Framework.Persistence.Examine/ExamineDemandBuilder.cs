...
using RebelCms.Framework.Persistence.Examine.Config;
using RebelCms.Framework.Persistence.Examine.Hive;
using RebelCms.Framework.Persistence.Examine.Mapping;
...
namespace RebelCms.Framework.Persistence.Examine
{
    ...
    public class ExamineDemandBuilder : AbstractProviderDependencyBuilder
    {
        ...
        public override void Initialise(IBuilderContext builderContext)
        {
            ...
            {
                LogHelper.Warn<ExamineDemandBuilder>("Could not load RebelCmsInternalIndexer, the configuration section could not be read.");
                CanBuild = false;
                return;
            }
            ...
            {
                LogHelper.Warn<ExamineDemandBuilder>("Could not load RebelCmsInternalSearcher, the configuration section could not be read.");
                CanBuild = false;
                return;
            }                
            ...
            {
                LogHelper.Warn<ExamineDemandBuilder>("Could not load RebelCmsInternalIndexSet, the configuration section could not be read.");
                CanBuild = false;
                return;
            }
        ...
        public override void Build(IContainerBuilder containerBuilder, IBuilderContext context)
        {
            ...
            containerBuilder.ForFactory(x => new RebelCmsExamineIndexer(indexSets))
