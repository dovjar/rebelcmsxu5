...
namespace RebelCms.Framework.DependencyManagement.Autofac
{
    public class AutofacMvcResolver : AbstractDependencyResolver, System.Web.Mvc.IDependencyResolver
    {
        ...
        public AutofacMvcResolver(IDependencyResolver resolver)
            : base(resolver)
        {
            var incomingRebelCmsResolver = resolver as AutofacResolver;
            if (incomingRebelCmsResolver == null)
                throw new ArgumentException("Must be of type 'RebelCms.Framework.DependencyManagement.Autofac.AutofacResolver'", "resolver");

            _mvcSpecificDependencyResolver = new AutofacDependencyResolver(incomingRebelCmsResolver.AutofacContainer);
