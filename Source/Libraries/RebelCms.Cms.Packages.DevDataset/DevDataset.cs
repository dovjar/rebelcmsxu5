...
namespace RebelCms.Cms.Packages.DevDataset
{
    ...
    public class DevDataset
    {
        ...
        public DevDataset(IPropertyEditorFactory propertyEditorFactory, IFrameworkContext frameworkContext, IAttributeTypeRegistry attributeTypeRegistry)
        {
            ...
            InitTemplates();
            InitDocTypes();
            _nodeData = XDocument.Parse(Files.RebelCms);
        ...
        /// <summary>
        /// creates a test repository of RebelCmsNodes
        /// </summary>
            ...
            contentPage.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "RebelCms Hide in Nav", Alias = "RebelCmsNaviHide", TabId = contentPage.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faq.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "RebelCms Hide in Nav", Alias = "RebelCmsNaviHide", TabId = faq.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faqCategory.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "RebelCms Hide in Nav", Alias = "RebelCmsNaviHide", TabId = faqCategory.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faqQuestion.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "RebelCms Hide in Nav", Alias = "RebelCmsNaviHide", TabId = faqQuestion.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
                });
