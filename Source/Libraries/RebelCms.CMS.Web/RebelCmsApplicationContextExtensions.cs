namespace RebelCms.Cms.Web
{
    ...
    public static class RebelCmsApplicationContextExtensions
    {
        ...
        /// <returns> </returns>
        public static bool AllProvidersInstalled(this IRebelCmsApplicationContext appContext)
        {
        ...
        public static bool AnyProvidersHaveStatus(this IRebelCmsApplicationContext appContext, InstallStatusType status)
        {
