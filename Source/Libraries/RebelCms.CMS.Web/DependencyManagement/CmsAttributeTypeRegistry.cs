...
<preValues>
    ...
    <preValue name='Features'><![CDATA[backcolor,bold,bullist,numlist,code,image,italic,underline,justifycenter,justifyfull,justifyleft,justifyright,RebelCmslink,unlink,RebelCmsmacro,RebelCmsmedia]]></preValue>
...
<preValues>
    <preValue name='Mode'><![CDATA[CheckboxList]]></preValue>
    <preValue name='ListItems' dataSource='RebelCms.Cms.Web.PropertyEditors.ListPicker.DataSources.ApplicationsListPickerDataSource, RebelCms.Cms.Web.PropertyEditors' />
</preValues>"
            });
