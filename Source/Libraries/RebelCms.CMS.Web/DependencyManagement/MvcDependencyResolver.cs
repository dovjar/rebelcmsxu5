namespace RebelCms.Cms.Web.DependencyManagement
{
    ...
    using AbstractDependencyResolver = RebelCms.Framework.DependencyManagement.AbstractDependencyResolver;

    /// <summary>
    ///   A class which passes requests from ASP.NET Mvc's <see cref="IDependencyResolver" /> to RebelCms's equivalent <see
    ///    cref="RebelCms.Framework.DependencyManagement.IDependencyResolver" /> .
    /// </summary>
    public class MvcDependencyResolver : AbstractDependencyResolver, IDependencyResolver
    {
        ...
        public MvcDependencyResolver(
            global::RebelCms.Framework.DependencyManagement.IDependencyResolver dependencyResolver)
