...
{
    public class RebelCmsApplicationContext : DisposableObject, IRebelCmsApplicationContext
    {
        ...
        public RebelCmsApplicationContext(
            //ICmsHiveManager hive, 
            //HiveManager hive, 
            RebelCmsSettings settings, 
        ...
        // Note: this is done this dirty way because Autofac appears to think that multiple resolve operations for IRebelCmsApplicationContext
