...
{
    public enum RebelCmsRenderItemCaseType
    {
        Upper,
        Lower,
        Title,
    ...
    public enum RebelCmsRenderItemEncodingType
    {
        Url,
        Html,
        Unchanged
    ...
    {
        /// <summary>
        /// Used for rendering out the Form for BeginRebelCmsForm
        /// </summary>
        internal class RebelCmsForm : MvcForm
        {
            public RebelCmsForm(
        ...
        /// <summary>
        /// Helper method to create a new form to execute in the RebelCms request pipeline against a locally declared controller
        /// </summary>
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcForm BeginRebelCmsForm(this HtmlHelper html, string action, string controllerName,
            object additionalRouteVals = null,
            IDictionary<string, object> htmlAttributes = null)
        {
        ...
        /// <summary>
        /// Helper method to create a new form to execute in the RebelCms request pipeline to a surface controller plugin
        /// </summary>
        /// <param name="html"></param>
        /// <param name="action"></param>
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcForm BeginRebelCmsForm(this HtmlHelper html, string action, Guid surfaceId,
            object additionalRouteVals = null,
            IDictionary<string, object> htmlAttributes = null)
        {
            var settings = DependencyResolver.Current.GetService<RebelCmsSettings>();
            ...
            object additionalRouteVals = null)
        {
            ...
            //new RebelCmsForm:
            var theForm = new RebelCmsForm(htmlHelper.ViewContext, surfaceController, surfaceAction, area, surfaceId, additionalRouteVals);
