...
using PropertyEditorModel = RebelCms.Cms.Web.Model.BackOffice.PropertyEditors.EditorModel;
...
namespace RebelCms.Cms.Web.Model.BackOffice.Editors
{
    ...
    public class DocumentTypeProperty : TimestampedModel
    {
        ...
        /// </para>
        /// <para>
        /// Since an RebelCms administrator may want to use the same Data Type for different properties of a Document Type, it would be nicer to modify if this property is required or not instead of having
