...
namespace RebelCms.Cms.Web.Model.BackOffice.ParameterEditors
{
    public class EditorModel
    {
        ...
        /// <summary>
        /// A flag determining if the editor rendered shows the RebelCms standard field label, or
        /// if this model's editor will occupy the area where the label generally exists such as the rich text editor.
        /// </summary>
        [ReadOnly(true)]
        [ScaffoldColumn(false)]
        public virtual bool ShowRebelCmsLabel
        {
            get { return PropertyEditorModel.ShowRebelCmsLabel; }
        }
