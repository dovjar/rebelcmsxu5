...
namespace RebelCms.Cms.Web
{
    ...
    internal class RenderViewPageContext
    {
        ...
        private RebelCmsHelper _RebelCms;

        /// <summary>
        /// Gets an RebelCms helper
        /// </summary>
        public RebelCmsHelper RebelCms
        {
            get
            {
                return _RebelCms ?? (_RebelCms = GetService(ctx => ctx.RebelCms,
                                                          () => new RebelCmsHelper(_controllerContext, RoutableRequestContext, RenderModelFactory)));
            }
            internal set { _RebelCms = value; }
        }

        private IRebelCmsRenderModel _model;
        public IRebelCmsRenderModel RenderModel
        {
            get
            {
    ...
    public abstract class RenderViewPage : WebViewPage<Content>
    {
        ...
        public RebelCmsHelper RebelCms
        {
            get { return RenderViewPageContext.RebelCms; }
        }
