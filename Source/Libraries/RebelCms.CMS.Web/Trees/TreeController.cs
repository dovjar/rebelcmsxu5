...
namespace RebelCms.Cms.Web.Trees
{
    ...
    public abstract class TreeController : SecuredBackOfficeController
    {
        ...
        /// </remarks>
        protected abstract RebelCmsTreeResult GetTreeData(HiveId parentId, FormCollection queryStrings);
        ...
        [HttpGet]
        public virtual RebelCmsTreeResult Index(HiveId id, FormCollection querystrings)
        {
        ...
        /// <returns></returns>
        /// <remarks>
        /// This method ensure that all of the correct meta data is set for the root node so that the RebelCms application works
        ...
        /// </summary>
        /// <returns></returns>
        protected RebelCmsTreeResult RebelCmsTree()
        {
