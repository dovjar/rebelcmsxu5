...
{
    /// <summary>
    /// A utility class for use with front-end development containing many methods for accessing common APIs in RebelCms
    /// </summary>
    public class RebelCmsHelper
    {
        ...
        public RebelCmsHelper(ControllerContext controllerContext, IRoutableRequestContext requestContext, IRenderModelFactory modelFactory)
        {
