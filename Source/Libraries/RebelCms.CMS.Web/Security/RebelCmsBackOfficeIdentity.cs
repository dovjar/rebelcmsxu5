...
namespace RebelCms.Cms.Web.Security
{
    ...
    /// <summary>
    /// A custom user identity for the RebelCms backoffice
    /// </summary>
    /// <remarks>
    /// All values are lazy loaded for performance reasons as the constructor is called for every single request
    /// </remarks>
    public class RebelCmsBackOfficeIdentity : FormsIdentity
    {
        public RebelCmsBackOfficeIdentity(FormsAuthenticationTicket ticket)
            : base(ticket)
        {
