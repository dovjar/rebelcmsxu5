    ...
    public static class UrlHelperExtensions
    {
        ...
        public static string GetDashboardUrl(this UrlHelper url, string appAlias)
        {
            ...
            var dashboardControllerId =
                RebelCmsController.GetControllerId<EditorAttribute>(typeof(DashboardEditorController));
        ...
        public static string GetDashboardUrl(this UrlHelper url, Type controllerType, string appAlias)
        {
            ...
            return url.Action("Dashboard",
                                RebelCmsController.GetControllerName(controllerType),
                                new
                                    {
                                        editorId = RebelCmsController.GetControllerId<EditorAttribute>(controllerType).ToString("N"),
                                        appAlias = appAlias
                                    });
        }
        #endregion
        ...
        public static string GetSurfaceUrl(this UrlHelper url, string action, string id, Guid surfaceId)
        {
            ...
            var settings = DependencyResolver.Current.GetService<RebelCmsSettings>();
            var area = settings.RebelCmsPaths.BackOfficePath;
        ...
        /// <returns></returns>
        public static string GetEditorUrl(this UrlHelper url, HiveId id, Guid editorId, ComponentRegistrations preResolvedComponentRegistrations, RebelCmsSettings preResovledSettings)
        {
        ...
        /// <param name="preResovledSettings"></param>
        /// <returns></returns>
        public static string GetEditorUrl(this UrlHelper url, string action, HiveId? id, Guid editorId, ComponentRegistrations preResolvedComponentRegistrations, RebelCmsSettings preResovledSettings)
        {
        ...
        public static string GetEditorUrl(this UrlHelper url, string action, Guid editorId, object actionParams, ComponentRegistrations preResolvedComponentRegistrations, RebelCmsSettings preResovledSettings)
        {
            ...
            var area = preResovledSettings.RebelCmsPaths.BackOfficePath;
        ...
        public static string GetEditorUrl(this UrlHelper url, string action, Type controllerType, HiveId? id)
        {
            ...
            return url.GetEditorUrl(action,                                    
                                    id,
                                    RebelCmsController.GetControllerId<EditorAttribute>(controllerType),
        ...
        {
            var appTreeControllerName = RebelCmsController.GetControllerName(typeof(ApplicationTreeController));
            var appTreeControllerId = RebelCmsController.GetControllerId<TreeAttribute>(typeof(ApplicationTreeController));
        ...
        public static string GetTreeUrl(this UrlHelper url, string applicationAlias)
        {
            ...
            var appTreeControllerId =
                RebelCmsController.GetControllerId<TreeAttribute>(typeof(ApplicationTreeController));
        ...
        public static string GetTreeUrl(this UrlHelper url, string action, Type treeType, HiveId id, FormCollection queryStrings)
        {
            ...
            return url.GetTreeUrl(action,
                                  id,
                                  RebelCmsController.GetControllerId<TreeAttribute>(treeType), queryStrings);
        }
        #endregion
            ...
            using (var securityUow = appContext.Hive.OpenReader<ISecurityStore>())
            {
                ...
                using (var fileUow = appContext.Hive.OpenReader<IFileStore>(fileId.ToUri()))
                {
                    ...
                    else // Proxy
                    {
                        ...
                        // Check permissions
                        //var authAttr = new RebelCmsAuthorizeAttribute {AllowAnonymous = true, Permissions = new [] { FixedPermissionIds.View }};
        ...
        /// <summary>
        /// Gets the RebelCms settings.
        /// </summary>
        /// <param name="url">The URL.</param>
        /// <returns></returns>
        private static RebelCmsSettings GetRebelCmsSettings(this UrlHelper url)
        {
            var umbSettings = DependencyResolver.Current.GetService<RebelCmsSettings>();
            return umbSettings;
        }
        ...
        {
            return url.Content(url.GetRebelCmsSettings().RebelCmsPaths.BackOfficePath);
        }
        ...
        {
            return url.Content(url.GetRebelCmsSettings().RebelCmsFolders.BackOfficeFolder);
        }
        ...
        {
            return url.Content(url.GetRebelCmsSettings().RebelCmsFolders.ApplicationIconFolder);
        }
        ...
        {
            return url.Content(url.GetRebelCmsSettings().PluginConfig.PluginsPath);
        }
