...
namespace RebelCms.Cms.Web.Routing
{
    ...
    internal class IgnorePluginRoute : Route
    {
        ...
        public IgnorePluginRoute(string url, string areaName, IRebelCmsApplicationContext appContext, IEnumerable<ControllerPluginMetadata> toIgnore)
        ...
        private class IgnoreExistingControllersConstraint : IRouteConstraint
        {
            ...
            public IgnoreExistingControllersConstraint(IRebelCmsApplicationContext appContext, string areaName, IEnumerable<ControllerPluginMetadata> toIgnore)
            {
                _appContext = appContext;
                _areaName = areaName;
            ...
            public bool Match(HttpContextBase httpContext, Route route, string parameterName, RouteValueDictionary values, RouteDirection routeDirection)
            {
                if (routeDirection == RouteDirection.IncomingRequest)
                {
                    ...
                    var backOfficePart = pathParts.IndexOf(_appContext.Settings.RebelCmsPaths.BackOfficePath);
