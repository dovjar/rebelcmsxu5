...
{
    /// <summary>
    /// The rules of this route constraint must pass in order to be able to route RebelCms requests to the front end
    /// </summary>
    public class RenderRouteConstraint : IncludeExcludeRouteConstraint
    {
        ...
        public RenderRouteConstraint(IRebelCmsApplicationContext applicationContext, IRenderModelFactory modelFactory)
