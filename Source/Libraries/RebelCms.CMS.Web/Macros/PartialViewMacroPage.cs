...
{
    public abstract class PartialViewMacroPage : WebViewPage<PartialViewMacroModel>, IRequiresRoutableRequestContext, IRequiresRebelCmsHelper
    {
        /// <summary>
        ...
        /// </summary>
        public RebelCmsHelper RebelCms { get; set; }
