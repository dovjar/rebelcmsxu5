...
namespace RebelCms.Cms.Web.Mvc.Metadata
{
    ...
    /// <summary>
    /// RebelCms meta data provider
    /// </summary>
    public class RebelCmsModelMetadataProvider : LocalizingModelMetadataProvider
    {
        ...
        protected override ModelMetadata CreateMetadata(IEnumerable<Attribute> attributes, Type containerType, Func<object> modelAccessor, Type modelType, string propertyName)
        {
            ...
            if (DocTypePropOverride(attributes))
            {
                ...
                metadata.AdditionalValues.Add(RebelCmsMetadataAdditionalInfo.AllowDocumentTypePropertyOverride.ToString(), true);
            }
