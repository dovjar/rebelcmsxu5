...
{
    /// <summary>
    /// A controller factory for the render pipeline of RebelCms 5. This controller factory tries to create a controller with the supplied
    /// name, and falls back to RebelCmsController if none was found.
    /// </summary>
    /// <remarks></remarks>
    public class RenderControllerFactory : IFilteredControllerFactory
    {
        ...
        /// </summary>
        public RenderControllerFactory(IRebelCmsApplicationContext applicationContext)
        {
        ...
        public IController CreateController(RequestContext requestContext, string controllerName)
        {
            Type controllerType = _innerFactory.GetControllerType(requestContext, controllerName) ??
                   _innerFactory.GetControllerType(requestContext, RebelCmsController.GetControllerName(typeof(RebelCmsController)));
        ...
        /// if the controller is not found. Since we want to try creating a controller, and then fall back to <see cref="RebelCmsController"/> if one isn't found,
