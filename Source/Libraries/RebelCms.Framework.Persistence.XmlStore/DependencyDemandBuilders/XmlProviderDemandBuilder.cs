...
namespace RebelCms.Framework.Persistence.XmlStore.DependencyDemandBuilders
{
    public class XmlProviderDemandBuilder : AbstractProviderDependencyBuilder
    {
        ...
        public override void Build(IContainerBuilder containerBuilder, IBuilderContext builderContext)
        {
            ...
            containerBuilder.ForFactory(context => new DataContextFactory(HostingEnvironment.MapPath("~/App_Data/RebelCms.config")))
