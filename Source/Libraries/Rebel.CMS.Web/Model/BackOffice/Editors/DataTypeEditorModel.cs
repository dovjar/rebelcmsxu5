...
namespace Rebel.Cms.Web.Model.BackOffice.Editors
{
    ...
    /// </remarks>
    [Bind(Exclude = "Alias,PreValueEditorModel,PropertyEditorPackage")]
    public class DataTypeEditorModel : EditorModel, IModelBindAware
    {
        ...
        /// </summary>
        [ReadOnly(true)]
        public string Alias { get { return _alias ?? (_alias = Name.ToRebelAlias()); } set { _alias = value; } }
        ...
        [ScaffoldColumn(false)]
        [ReadOnly(true)]
        public string PropertyEditorPackage { get; set; }
