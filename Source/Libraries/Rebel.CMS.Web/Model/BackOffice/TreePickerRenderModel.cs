...
namespace Rebel.Cms.Web.Model.BackOffice
{
    ...
    public class TreePickerRenderModel
    {
        ...
        {
            Id = Name = "gen_" + Guid.NewGuid().ToString("N");
        ...
        /// </value>
        [Obsolete("The TreeVirtualRootId property is no longer required, however if it is set then it will be used the same way it was previously to determine the Title of the root node")]
