...
namespace Rebel.Cms.Web.Model
{
    ...
    /// </summary>
    public class RebelRenderModel : DisposableObject, IRebelRenderModel
    {
        ...
        private readonly IRebelApplicationContext _baseContext;
        ...
        {
            get { return _renderItem != null; }
        }

        protected override void DisposeResources()
        {
            LogHelper.TraceIfEnabled<RebelRenderModel>("Disposing");
