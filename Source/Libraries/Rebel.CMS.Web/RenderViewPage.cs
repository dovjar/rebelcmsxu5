...
namespace Rebel.Cms.Web
{
    ...
    internal class RenderViewPageContext
    {
        ...
        private RebelHelper _rebel;

        /// <summary>
        /// Gets an rebel helper
        /// </summary>
        public RebelHelper Rebel
        {
            get
            {
                return _rebel ?? (_rebel = GetService(ctx => ctx.Rebel,
                                                          () => new RebelHelper(_controllerContext, RoutableRequestContext, RenderModelFactory)));
            }
            internal set { _rebel = value; }
        }

        private IRebelRenderModel _model;
        public IRebelRenderModel RenderModel
        {
            get
            {
    ...
    public abstract class RenderViewPage : WebViewPage<Content>
    {
        ...
        public RebelHelper Rebel
        {
            get { return RenderViewPageContext.Rebel; }
        }

        /// <summary>
        /// Gets the <see cref="CurrentPage"/>.
        /// </summary>
        /// <remarks></remarks>
        public dynamic CurrentPage
        {
            get { return RenderViewPageContext.CurrentPage; }
        }
