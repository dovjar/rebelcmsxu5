...
{
    public enum RebelRenderItemCaseType
    {
        Upper,
        Lower,
        Title,
    ...
    public enum RebelRenderItemEncodingType
    {
        Url,
        Html,
        Unchanged
    ...
    public static class HtmlHelperRenderExtensions
    {
        ...
        /// </summary>
        internal class RebelForm : MvcForm
        {
            public RebelForm(
        ...
        /// <returns></returns>
        public static MvcForm BeginRebelForm(this HtmlHelper html, string action, string controllerName)
        {
            return html.BeginRebelForm(action, controllerName, null, new Dictionary<string, object>());
        }
        ...
        {
            return html.BeginRebelForm(action, controllerName, additionalRouteVals, new Dictionary<string, object>());
        }
        ...
        {
            return html.BeginRebelForm(action, controllerName, additionalRouteVals, htmlAttributes.ToDictionary<object>());
        }
        ...
        /// <returns></returns>
        public static MvcForm BeginRebelForm(this HtmlHelper html, string action, Guid surfaceId)
        {
            return html.BeginRebelForm(action, surfaceId, null, new Dictionary<string, object>());
        }
        ...
        public static MvcForm BeginRebelForm(this HtmlHelper html, string action, Guid surfaceId,
            object additionalRouteVals)
        {
            return html.BeginRebelForm(action, surfaceId, additionalRouteVals, new Dictionary<string, object>());
        }
        ...
        public static MvcForm BeginRebelForm(this HtmlHelper html, string action, Guid surfaceId,
            ...
            object htmlAttributes)
        {
            return html.BeginRebelForm(action, surfaceId, additionalRouteVals, htmlAttributes.ToDictionary<object>());
        }
            ...
            object additionalRouteVals = null)
        {
            ...
            //new RebelForm:
            var theForm = new RebelForm(htmlHelper.ViewContext, surfaceController, surfaceAction, area, surfaceId, additionalRouteVals);
