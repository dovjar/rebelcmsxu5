...
namespace Rebel.Cms.Web.Mvc.ControllerFactories
{
    ...
    public class RenderControllerFactory : IFilteredControllerFactory
    {
        ...
        /// </summary>
        public RenderControllerFactory(IRebelApplicationContext applicationContext)
        {
        ...
        /// if the controller is not found. Since we want to try creating a controller, and then fall back to <see cref="RebelController"/> if one isn't found,
