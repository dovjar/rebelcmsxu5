...
namespace Rebel.Cms.Web.Mvc.Metadata
{
    ...
    /// </summary>
    public class RebelModelMetadataProvider : LocalizingModelMetadataProvider
    {
        ...
        protected override ModelMetadata CreateMetadata(IEnumerable<Attribute> attributes, Type containerType, Func<object> modelAccessor, Type modelType, string propertyName)
        {
            ...
            if (DocTypePropOverride(attributes))
            {
                ...
                metadata.AdditionalValues.Add(RebelMetadataAdditionalInfo.AllowDocumentTypePropertyOverride.ToString(), true);
            }
