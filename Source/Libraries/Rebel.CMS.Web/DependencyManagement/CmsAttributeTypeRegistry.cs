...
<preValues>
    <preValue name='TreeId'><![CDATA[" + CorePluginConstants.MediaTreeControllerId + @"]]></preValue>
            ...
            RegisterAttributeType(() => new AttributeType("integer", "Integer", "", new IntegerSerializationType())
                        {
...
<preValues>
    <preValue name='DecimalPlaces'><![CDATA[0]]></preValue>
            ...
            RegisterAttributeType(() => new AttributeType("decimal", "Decimal", "", new DecimalSerializationType())
                        {
