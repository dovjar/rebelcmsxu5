namespace Rebel.Cms.Web.DependencyManagement
{
    ...
    using AbstractDependencyResolver = Rebel.Framework.DependencyManagement.AbstractDependencyResolver;

    /// <summary>
    ///   A class which passes requests from ASP.NET Mvc's <see cref="IDependencyResolver" /> to Rebel's equivalent <see
    ///    cref="Rebel.Framework.DependencyManagement.IDependencyResolver" /> .
    /// </summary>
    public class MvcDependencyResolver : AbstractDependencyResolver, IDependencyResolver
    {
        ...
        public MvcDependencyResolver(
            global::Rebel.Framework.DependencyManagement.IDependencyResolver dependencyResolver)
