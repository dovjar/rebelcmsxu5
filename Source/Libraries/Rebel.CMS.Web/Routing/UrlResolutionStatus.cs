namespace Rebel.Cms.Web.Routing
{
    ...
    /// </summary>
    /// <remarks>Developer note: if modifying or adding entries, there is code such as <see cref="UrlResolutionResultExtensions.IsSuccess"/> which checks the integer value of these statusses</remarks>
