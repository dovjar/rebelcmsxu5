...
namespace Umbraco.Framework
{
    public static class ObjectExtensions
    {
        ...
        public static AttemptTuple<object> TryConvertTo(this object input, Type destinationType)
        {
            ...
            if(destinationType == typeof(object)) return new AttemptTuple<object>(true, input);
        ...
        /// <returns></returns>
        public static AttemptTuple<string> TryConvertToXmlString(this object value, Type type)
        {
            try
            {
                var output = value.ToXmlString(type);
                return new AttemptTuple<string>(true, output);
            }
            catch (NotSupportedException ex)
            {
                return new AttemptTuple<string>(ex);
            }
        } 
