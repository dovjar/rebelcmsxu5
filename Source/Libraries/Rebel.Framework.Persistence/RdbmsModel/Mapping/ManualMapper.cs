    ...
    public class ManualMapperv2 : AbstractMappingEngine
    {
        ...
        public override void Configure()
        {
            using (new WriteLockDisposable(_locker))
            {
                ...
                _delegatedMapHandlers.Add<NodeVersion, IRevision<TypedEntity>>(_rdbmsToModelMapper.MapRevision, _rdbmsToModelMapper.MapRevision, true);
                _delegatedMapHandlers.Add<IRevision<TypedEntity>, NodeVersion>(ModelToRdbmsMapper.MapFromRevision, ModelToRdbmsMapper.MapFromRevision, true);
