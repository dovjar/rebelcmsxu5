...
using AttributeDefinition = Rebel.Framework.Persistence.Model.Attribution.MetaData.AttributeDefinition;
using AttributeType = Rebel.Framework.Persistence.Model.Attribution.MetaData.AttributeType;

namespace Rebel.Framework.Persistence
{
    ...
    public static class PersistenceExtensions
    {
        ...
        /// <returns></returns>
        /// <remarks>This overload exists because it's not possible to have an optional parameter in an expression tree, so <see cref="Attribute{T}(Rebel.Framework.Persistence.Model.TypedEntity,string,T)"/> cannot be used in queries.</remarks>
        public static T Attribute<T>(this TypedEntity entity, [MapsToAliasForQuerying]string alias)
        {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static T Attribute<T>(this TypedEntity entity, [MapsToAliasForQuerying]string alias, T defaultValue = default(T))
        {
        ...
        /// <param name="defaultValue">The default value.</param>
        /// <returns></returns>
        public static T InnerAttribute<T>(this TypedEntity entity, [MapsToAliasForQuerying]string alias, [MapsToInnerAliasForQuerying]string valueKey, T defaultValue = default(T))
        {
            if (!entity.Attributes.Contains(alias)) return defaultValue;
            var attribute = entity.Attributes[alias];
            if (attribute == null) return defaultValue;
            if (!attribute.Values.ContainsKey(valueKey)) return defaultValue;
            var value = attribute.Values[valueKey];
            if (value == null) return defaultValue;
            var converted = value.TryConvertTo<T>();
            return converted.Success ? converted.Result : defaultValue;
        }
        ...
        /// <returns></returns>
        public static object GetValue(this TypedAttribute a, [MapsToInnerAliasForQuerying]string key)
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static string GetValueAsString(this TypedAttribute a, [MapsToInnerAliasForQuerying]string key)
        {
        ...
        /// <returns></returns>
        public static string GetAttributeValueAsString(this TypedEntity entity, [MapsToAliasForQuerying]string attributeAlias)
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static string GetAttributeValueAsString(this TypedEntity entity, [MapsToAliasForQuerying]string attributeAlias, [MapsToInnerAliasForQuerying]string key)
        {
        ...
        /// <param name="attributeAlias"></param>
        /// <returns></returns>
        public static dynamic GetAttributeValue(this TypedEntity entity, [MapsToAliasForQuerying]string attributeAlias)
        {
            var attribute =
        ...
        /// <returns></returns>
        public static dynamic GetAttributeValue(this TypedEntity entity, [MapsToAliasForQuerying]string attributeAlias, [MapsToInnerAliasForQuerying]string valueKey)
        {
            var attribute =
                entity.Attributes.FirstOrDefault(
                    x =>
        ...
        public static void SetupFromSchema(this TypedEntity entity, EntitySchema schema)
        {
            ...
            {
                var inheritedAttributeDefinitions = compositeSchema.AllAttributeDefinitions.ToArray();
                foreach (var attributeDefinition in inheritedAttributeDefinitions)
                {
