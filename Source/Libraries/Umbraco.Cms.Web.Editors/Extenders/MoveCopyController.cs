            ...
            return ProcessMoveCopy(model.SelectedItemId, model.ToId, (copyFrom, parentEntity, uow) =>
                {
                    ...
                    copied.Attributes[NodeNameAttributeDefinition.AliasValue].Values["Name"] = "Copy of " +
                        copied.InnerAttribute<string>(NodeNameAttributeDefinition.AliasValue, "Name");

                    copied.Attributes[NodeNameAttributeDefinition.AliasValue].Values["UrlName"] = "copy-of-" +
                        copied.InnerAttribute<string>(NodeNameAttributeDefinition.AliasValue, "UrlName");
                    ...
                    return new Tuple<string, EntityPathCollection, string>(
                        ...
                        uow.Repositories.GetEntityPaths<TypedEntity>(copied.Id, FixedRelationTypes.DefaultRelationType),
                        "copy");
                });
        }
