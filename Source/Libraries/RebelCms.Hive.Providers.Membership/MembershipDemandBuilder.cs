...
using RebelCms.Hive.Providers.Membership.Hive;
using RebelCms.Hive.Providers.Membership.Mapping;
using ProviderMetadata = RebelCms.Framework.Persistence.ProviderSupport._Revised.ProviderMetadata;

namespace RebelCms.Hive.Providers.Membership
{
    /// <summary>
