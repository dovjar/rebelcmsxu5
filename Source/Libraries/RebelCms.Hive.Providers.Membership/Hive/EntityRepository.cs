...
using RebelCms.Hive.Providers.Membership.Linq;
        ...
        protected override void PerformAddOrUpdate(TypedEntity entity)
        {
            ...
            foreach (var m in MembershipProviders)
            {
                ...
                var member = m.CreateUser(
                    entity.Attribute<string>("username".ToRebelCmsAlias()),
                    entity.Attribute<string>("password".ToRebelCmsAlias()),
                    entity.Attribute<string>("email".ToRebelCmsAlias()),
                    entity.Attribute<string>("passwordQuestion".ToRebelCmsAlias()),
                    entity.Attribute<string>("passwordAnswer".ToRebelCmsAlias()),
                    entity.Attribute<bool>("isApproved".ToRebelCmsAlias()),
