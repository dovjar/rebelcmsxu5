        ...
        ICollection
    {
        ...
        object ICollection.SyncRoot
        {
            get
            {
                ...
                {
                    ICollection collection = this._source as ICollection;
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.Contains(
            KeyValuePair<TKey, TValue> item)
        {
            ICollection<KeyValuePair<TKey, TValue>> collection = this._source;
        ...
        {
            IEnumerable<KeyValuePair<TKey, TValue>> enumerator = this._source;
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ICollection collection =
                new List<KeyValuePair<TKey, TValue>>(this._source);
