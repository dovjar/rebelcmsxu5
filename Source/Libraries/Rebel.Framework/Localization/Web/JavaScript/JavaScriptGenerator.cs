...
using Rebel.Framework.Localization.Processing;
...
using Rebel.Framework.Localization.Web.JavaScript.FormatGroupExpanders;
using Rebel.Framework.Localization.Web.JavaScript.ParameterEvaluators;
using Rebel.Framework.Localization.Web.JavaScript.SwitchConditions;
using Rebel.Framework.Localization.Web.JavaScript.ValueFormatters;

[assembly: WebResource("Rebel.Framework.Localization.Web.JavaScript.Resources.Localization.js", "text/javascript")]
[assembly: WebResource("Rebel.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxGlobalization.js", "text/javascript")]
[assembly: WebResource("Rebel.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxCore.js", "text/javascript")]
...
namespace Rebel.Framework.Localization.Web.JavaScript
{
    ...
    {        
        ...
        public static IEnumerable<Tuple<Type, string>> ScriptResourceDependencies
        {
            get
            {
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "Rebel.Framework.Localization.Web.JavaScript.Resources.Localization.js");
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "Rebel.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxCore.js");
                yield return Tuple.Create(typeof (JavaScriptGenerator),
                    "Rebel.Framework.Localization.Web.JavaScript.Resources.MicrosoftAjaxGlobalization.js");
            }
        }
        ...
        {            
            ...
            output.Write("=new Rebel.Framework.Localization.TextManager(");
