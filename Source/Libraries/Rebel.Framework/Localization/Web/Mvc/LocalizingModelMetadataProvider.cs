...
namespace Rebel.Framework.Localization.Web.Mvc
{
    ...
    /// - Namespace part after the assembly's default namespace . Class name . Property name (e.g. the property "Name" of the class "Rebel.Framework.Web.Models.CoreEntityModel" becomes Models.CoreEntityModel.Name)
