namespace Rebel.Framework
{
    ...
    public static class TaskTriggers
    {
        public static class Hive
        {
            ...
            public const string PreDelete = "hive-pre-delete-before-unit-complete";
            public const string PostDelete = "hive-post-delete-before-unit-complete";

            public const string PreDeleteOnUnitComplete = "hive-pre-delete-after-unit-complete";
            public const string PostDeleteOnUnitComplete = "hive-post-delete-after-unit-complete";

            public static class Schemas
            {
                public const string PreAddOrUpdateOnUnitComplete = "hive-pre-add-or-update-schema-after-unit-complete";
                public const string PostAddOrUpdateOnUnitComplete = "hive-post-add-or-update-schema-after-unit-complete";

                public const string PreAddOrUpdate = "hive-pre-add-or-update-schema-before-unit-complete";
                public const string PostAddOrUpdate = "hive-post-add-or-update-schema-before-unit-complete";
            }

            public static class Revisions
            {
                public const string PreAddOrUpdateOnUnitComplete = "hive-pre-add-or-update-revision-after-unit-complete";
                public const string PostAddOrUpdateOnUnitComplete = "hive-post-add-or-update-revision-after-unit-complete";

                public const string PreAddOrUpdate = "hive-pre-add-or-update-revision-before-unit-complete";
                public const string PostAddOrUpdate = "hive-post-add-or-update-revision-before-unit-complete";               
            }
