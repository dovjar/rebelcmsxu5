...
namespace Rebel.Framework.Dynamics.Expressions
{
    public class ExpressionParser
    {
        public static LambdaExpression ParseLambda(Type itType, Type resultType, string expression, params object[] values)
        {
            return ParseLambda(new ParameterExpression[1]
              {
            ...
            Type signatures, string opName, ref Expression left, ref Expression right, int errorPos)
        {
            ...
            // Start Rebel mod: If this is a dynamic member, wrap the expression in a cast so that the types are equal
