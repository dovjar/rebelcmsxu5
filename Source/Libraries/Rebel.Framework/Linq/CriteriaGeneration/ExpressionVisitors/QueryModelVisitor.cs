namespace Rebel.Framework.Linq.CriteriaGeneration.ExpressionVisitors
{
    using System;
    ...
    public class QueryModelVisitor : QueryModelVisitorBase
    {
        ...
        private void RunCustomModifiers(QueryModel subQueryModel)
        {
            ...
            {
                modifier.ModifyQueryDescription(_queryDescription, subQueryModel.MainFromClause.ItemType);
            }
        }
        ...
        private static Type GetResultType(QueryModel queryModel)
        {
            ...
            return resultTypeOverride ?? queryModel.MainFromClause.ItemType;
        }
