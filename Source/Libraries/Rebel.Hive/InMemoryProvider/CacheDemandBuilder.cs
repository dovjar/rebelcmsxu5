namespace Rebel.Hive.InMemoryProvider
{
    ...
    public class CacheDemandBuilder : AbstractProviderDependencyBuilder
    {
        ...
        /// <summary>
        /// Initialises the provider dependency builder. This method is run by <see cref="Rebel.Hive.DependencyManagement.ProviderDemandRunner"/> prior to it calling <see cref="AbstractProviderDependencyBuilder.Build"/>.
        /// </summary>
