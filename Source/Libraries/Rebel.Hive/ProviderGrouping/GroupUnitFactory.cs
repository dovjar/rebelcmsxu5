...
namespace Rebel.Hive.ProviderGrouping
{
    ...
    public interface IGroupUnitFactory<out TFilter> where TFilter : class, IProviderTypeFilter
    {
        IGroupUnit<TFilter> Create();
    }

    public class GroupUnitFactory<TFilter> : GroupUnitFactory, IGroupUnitFactory<TFilter> where TFilter : class, IProviderTypeFilter
    {
