...
using Rebel.Hive.DependencyManagement;
...
namespace Rebel.Hive
{
    ...
    public abstract class AbstractProviderDependencyBuilder : IDependencyDemandBuilder
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance can build dependencies. Used by <see cref="ProviderDemandRunner"/> to determine if the <see cref="Build(Rebel.Framework.DependencyManagement.IContainerBuilder,Rebel.Framework.DependencyManagement.IBuilderContext)"/> method on this demand builder should be run.
        /// </summary>
        ...
        /// <summary>
        /// Initialises the provider dependency builder. This method is run by <see cref="Rebel.Hive.DependencyManagement.ProviderDemandRunner"/> prior to it calling <see cref="Build(Rebel.Framework.DependencyManagement.IContainerBuilder,Rebel.Framework.DependencyManagement.IBuilderContext)"/>.
        /// </summary>
