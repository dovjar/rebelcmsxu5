...
using RebelCms.Framework.Persistence.RdbmsModel;
using AttributeDefinition = RebelCms.Framework.Persistence.Model.Attribution.MetaData.AttributeDefinition;
using AttributeType = RebelCms.Framework.Persistence.Model.Attribution.MetaData.AttributeType;

namespace RebelCms.Framework.Persistence
{
    ...
    public static class PersistenceExtensions
    {
        ...
        /// <returns></returns>
        /// <remarks>This overload exists because it's not possible to have an optional parameter in an expression tree, so <see cref="Attribute{T}(RebelCms.Framework.Persistence.Model.TypedEntity,string,T)"/> cannot be used in queries.</remarks>
