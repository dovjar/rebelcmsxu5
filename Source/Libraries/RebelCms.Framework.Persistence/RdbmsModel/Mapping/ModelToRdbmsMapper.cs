...
namespace RebelCms.Framework.Persistence.RdbmsModel.Mapping
{
    ...
    public static class ModelToRdbmsMapper
    {
        ...
        public static void MapAttributeTypeDefinition(Model.Attribution.MetaData.AttributeType source, AttributeType destination, AbstractLookupHelper lookupHelper, AbstractMappingEngine masterMapper)
        {
            ...
            destination.Alias = source.Alias ?? StringExtensions.ToRebelCmsAlias(source.Name);
            ...
            destination.TrySetPropertyFromDirty(toProp => toProp.Alias, source, fromProp => fromProp.Alias, () => source.Alias ?? StringExtensions.ToRebelCmsAlias(source.Name));
