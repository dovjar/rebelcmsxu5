...
namespace RebelCms.Framework.Persistence.RdbmsModel
{
    /// <summary>Class which represents the entity 'AttributeIntegerValue'</summary>
    [Serializable]
    public partial class AttributeDecimalValue : AbstractEquatableObject<AttributeDecimalValue>, IReferenceByGuid
    {
