...
//[assembly: WebResource("Rebel.Cms.Packaging.Editors.Resources.Packaging.css", "text/css", PerformSubstitution = true)]
//[assembly: WebResource("Rebel.Cms.Packaging.Editors.Resources.PackagingInstaller.js", "application/x-javascript")]
//[assembly: WebResource("Rebel.Cms.Packaging.Editors.Resources.AppRestarter.js", "application/x-javascript")]
        ...
        public virtual ActionResult Browse(string path)
        {
            ...
            else
            {
                ...
                foreach (var folder in folders)
                {
                    ...
                    {
                        HasChildren = true,
                        EditorUrl = "Rebel.Editors.PackageEditor.nodeClickHandler",
            ...
            return new RebelTreeResult(nodes, ControllerContext);
