...
namespace Umbraco.Framework.Persistence.Model.Attribution.MetaData
{
    ...
    public class EntitySchema : AbstractSchemaPart<EntitySchema>, IReferenceByName, IRelatableEntity, IVersionableEntity
    {
        ...
        private EntityCollection<AttributeDefinition> _attributeDefinitions;
        ...
        public EntitySchema()
        {
            AttributeDefinitions = new EntityCollection<AttributeDefinition>();
        ...
        public EntityCollection<AttributeDefinition> AttributeDefinitions
        {
            ...
            set
            {
                _attributeDefinitions.IfNotNull(x => x.CollectionChanged -= AttributeDefinitionsCollectionChanged);
        ...
        [DataMember]
        public string StringXmlConfiguration
        {
            get { return XmlConfiguration.ToString(); }
            set
            {
                try
                {
                    XmlConfiguration = XDocument.Parse(value);
                }
                catch (Exception)
                {
                }
        ...
        public bool IsAbstract
        {
            ...
            set
            {
                SetXmlConfigProperty("is-abstract", value);
            }
        }
