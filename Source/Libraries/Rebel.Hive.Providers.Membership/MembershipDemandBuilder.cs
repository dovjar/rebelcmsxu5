...
using Rebel.Hive.Providers.Membership.Hive;
using Rebel.Hive.Providers.Membership.Mapping;
using ProviderMetadata = Rebel.Framework.Persistence.ProviderSupport._Revised.ProviderMetadata;

namespace Rebel.Hive.Providers.Membership
{
    /// <summary>
