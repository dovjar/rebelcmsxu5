...
namespace Rebel.Cms.Packages.SnapshotDashboard.Controllers
{
    ...
    public class CreateSnapshotDashboardController : DashboardEditorController
    {
        ...
        public JsonResult CreateSnapshot(SnapshotModel model)
        {
            ...
            {
                // Create folder
                var folder = new Rebel.Framework.Persistence.Model.IO.File(snap, "") { IsContainer = true };
