...
using RebelCms.Framework.Persistence.NHibernate.OrmConfig;
        ...
        public override void ConfigureApplication(string providerKey, XDocument configXml, BendyObject installParams)
        {
            ...
            switch (dbType)
            {
                ...
                case "MySQL":
                    ...
                    break;
                case "SQLCE":
                    connectionString = "Data Source=|DataDirectory|RebelCms.sdf";
            ...
            DeepConfigManager.SerializeProviderConfigSection(configXml, hiveElement, "RebelCms/persistenceProviderSettings/" + elementName, true);
