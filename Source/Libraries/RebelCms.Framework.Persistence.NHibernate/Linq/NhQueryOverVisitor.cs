...
using Attribute = RebelCms.Framework.Persistence.RdbmsModel.Attribute;

namespace RebelCms.Framework.Persistence.NHibernate.Linq
{
    using RebelCms.Framework.Linq.CriteriaGeneration.Expressions;

    using RebelCms.Framework.Linq.CriteriaTranslation;
