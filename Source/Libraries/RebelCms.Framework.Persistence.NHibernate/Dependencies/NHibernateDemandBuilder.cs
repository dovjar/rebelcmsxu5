...
namespace RebelCms.Framework.Persistence.NHibernate.Dependencies
{
    public class NHibernateDemandBuilder : AbstractProviderDependencyBuilder
    {
        ...
        /// <summary>
        /// Initialises the provider dependency builder. This method is run by <see cref="RebelCms.Hive.DependencyManagement.ProviderDemandRunner"/> prior to it calling <see cref="Build"/>.
        /// </summary>
            ...
            _localConfig = !string.IsNullOrEmpty(config2rw.ConfigSectionKey)
                              ? DeepConfigManager.Default.GetFirstWebSetting
                                    <ProviderConfigurationSection, ProviderConfigurationSection>(
                                        config2rw.ConfigSectionKey, x => x, "~/App_Data/RebelCms/HiveConfig")
                                ??
