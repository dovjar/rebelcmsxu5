...
(function ($) {
    ...
    RebelCms.PropertyEditors.TextBoxPropertyEditor = function() {
        ...
        return {
			...
			charLimit: function (_opts) {
				...
				// TODO: i18n/L10n
				var _status = $('<div id="' + _opts.RebelCmsPropertyId + '_Status" class="text-box-status">You have ' + (_limit - _field.val().length) + ' characters left.</div>');
            ...
            init: function(_opts) {
                var _this = this;
                var propertyEditor = new RebelCms.PropertyEditors.PropertyEditor(_opts.RebelCmsPropertyId);
                RebelCms.PropertyEditors.PropertyEditorManager.getInstance().registerPropertyEditor(propertyEditor, function (ctx) {
                    ...
                    $("#" + _opts.RebelCmsPropertyId + " textarea").mousedown(function (e) {
                        RebelCms.PropertyEditors.PropertyEditorManager.getInstance().setFocus(e, propertyEditor);
                    })
                });
            },
