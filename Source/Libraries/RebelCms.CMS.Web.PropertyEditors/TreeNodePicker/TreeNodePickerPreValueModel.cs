...
namespace RebelCms.Cms.Web.PropertyEditors.TreeNodePicker
{
    ...
    public class TreeNodePickerPreValueModel : PreValueModel
    {
        ...
        [EmbeddedView("RebelCms.Cms.Web.PropertyEditors.TreeNodePicker.Views.TreeTypeDropDown.cshtml", "RebelCms.Cms.Web.PropertyEditors")]
        ...
        /// <summary>
        /// Returns the trees available within RebelCms
        /// </summary>
        /// <returns></returns>
