...
[assembly: WebResource("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Resources.InsertMedia.InsertMedia.js", "application/x-javascript")]
...
namespace RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Controllers
{
    ...
    public class InsertMediaController : AbstractEditorController
    {
        ...
        {
           return View(EmbeddedViewPath.Create("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.InsertMedia.cshtml, RebelCms.Cms.Web.PropertyEditors"));
        }
        ...
        public JsonResult GetMediaParameters(HiveId mediaId)
        {
            ...
            try
            {
                view = BuildManager.CreateInstanceFromVirtualPath(
                    ...
                    string.Format("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.{0}.cshtml, RebelCms.Cms.Web.PropertyEditors", ext)))
                    , typeof(object));
            ...
            catch (TypeLoadException e)
            {
                ...
                view = BuildManager.CreateInstanceFromVirtualPath(
                    EmbeddedViewPath.GetFullPath(EmbeddedViewPath.Create(
                   "RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.default.cshtml, RebelCms.Cms.Web.PropertyEditors"))
                   , typeof(object));
        ...
        public ActionResult GetMediaPreview(HiveId mediaId)
        {
            ...
            RebelCms.Framework.Dynamics.BendyObject bendyParams = new Framework.Dynamics.BendyObject(mediaParamsDict);
            ...
            try
            {
                ...
                return View(EmbeddedViewPath.Create(
                    string.Format("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.{0}.preview.cshtml, RebelCms.Cms.Web.PropertyEditors", ext)), model);
            }
            catch (TypeLoadException e)
            {
                ...
                return View(EmbeddedViewPath.Create(
                   "RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.default.preview.cshtml, RebelCms.Cms.Web.PropertyEditors"), model);
            }
        }
        ...
        public ActionResult GetMediaMarkup(HiveId mediaId, string mediaParameters = "")
        {
            ...
            try
            {
                //try returning embedded view for extension
                return View(EmbeddedViewPath.Create(
                    string.Format("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.{0}.cshtml, RebelCms.Cms.Web.PropertyEditors", ext)), model);
            }
            catch (TypeLoadException e)
            {
                //view for extension not found, return default image view
                var viewType = EmbeddedViewPath.Create("RebelCms.Cms.Web.PropertyEditors.RichTextBox.TinyMCE.Views.InsertMedia.Types.default.cshtml, RebelCms.Cms.Web.PropertyEditors");
