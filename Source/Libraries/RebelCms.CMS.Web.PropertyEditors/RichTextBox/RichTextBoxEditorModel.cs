...
{
    [EmbeddedView("RebelCms.Cms.Web.PropertyEditors.RichTextBox.Views.RichTextBoxEditor.cshtml", "RebelCms.Cms.Web.PropertyEditors")]
    public class RichTextBoxEditorModel : EditorModel<RichTextBoxPreValueModel>, IValidatableObject
    {
        ...
        public RichTextBoxEditorModel(RichTextBoxPreValueModel preValues, IRebelCmsApplicationContext appContext, HiveId currNodeId)
            : base(preValues)
        {
        ...
        /// </summary>
        public IRebelCmsApplicationContext AppContext
        {
            get
            {
                return _appContext;
        ...
        /// <summary>
        /// Based on the pre-value options, the RebelCms label will be toggled
        /// </summary>
        public override bool ShowRebelCmsLabel
        {
            get
            {
