...
/// <reference path="/Areas/RebelCms/Scripts/RebelCms.RebelCms.System/UrlEncoder.js" />
...
(function ($, Base) {
    ...
    RebelCms.PropertyEditors.MultipleTextstringPropertyEditor = Base.extend({
        ...
        viewModel: {
            ...
            addRow: function (idx) {
                ...
                $("#" + this.RebelCmsPropertyId + " li input[type=text]:eq(" + idx + ")").focus();
            }
        },
        ...
        init: function (o) {
            ...
            this.viewModel.RebelCmsPropertyId = o.RebelCmsPropertyId;

            var textstrings = $("#" + o.RebelCmsPropertyId +"_Value").val().split("\n");
            ...
            $("#" + o.RebelCmsPropertyId + " li input[type=text]").live("keydown", function(e) {
                ...
                if(keyCode == 40) { // Down arrow
                    var input = $("#" + _this.viewModel.RebelCmsPropertyId + " li:eq(" + Math.min(idx + 1, _this.viewModel.textstrings().length - 1) + ") input[type=text]").get(0);
                    _this._focusInput(input);
                    flag = true;
                }
                if(keyCode == 38) { // Up arrow
                    var input = $("#" + _this.viewModel.RebelCmsPropertyId + " li:eq(" + Math.max(idx - 1, 0) + ") input[type=text]").get(0);
                    _this._focusInput(input);
                    flag = true;
                }
            ...
            ko.applyBindings(this.viewModel, $("#"+ this.viewModel.RebelCmsPropertyId).get(0));
        }
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new RebelCms.PropertyEditors.MultipleTextstringPropertyEditor();
