...
namespace Rebel.Cms.Packages.DevDataset
{
    ...
    public class DevDataset
    {
        ...
        /// <summary>
        /// creates a test repository of RebelNodes
        /// </summary>
            ...
            contentPage.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "Rebel Hide in Nav", Alias = "rebelNaviHide", TabId = contentPage.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faq.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "Rebel Hide in Nav", Alias = "rebelNaviHide", TabId = faq.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faqCategory.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "Rebel Hide in Nav", Alias = "rebelNaviHide", TabId = faqCategory.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
            ...
            faqQuestion.Properties = new HashSet<DocumentTypeProperty>(new[]
                {
                    ...
                    new DocumentTypeProperty(new HiveId(Guid.NewGuid()), _dataTypes[1]) { Name = "Rebel Hide in Nav", Alias = "rebelNaviHide", TabId = faqQuestion.DefinedTabs.ElementAt(1).Id, SortOrder = 4 },
                });
            ...
            _templates = new List<TemplateFile>
                            {
                                ...
                                new TemplateFile(new HiveId(providerGroupRoot, "templates", new HiveIdValue("BooksPage.cshtml")))
                                    {                                        
                                        Name = "Books Page"
                                    },
                                new TemplateFile(new HiveId(providerGroupRoot, "templates", new HiveIdValue("BookPage.cshtml")))
                                    {                                        
                                        Name = "Book Page"
                                    }
                            };
