...
namespace Rebel.Framework.DependencyManagement.Autofac
{
    public class AutofacMvcResolver : AbstractDependencyResolver, System.Web.Mvc.IDependencyResolver
    {
        ...
        public AutofacMvcResolver(IDependencyResolver resolver)
            : base(resolver)
        {
            var incomingRebelResolver = resolver as AutofacResolver;
            if (incomingRebelResolver == null)
                throw new ArgumentException("Must be of type 'Rebel.Framework.DependencyManagement.Autofac.AutofacResolver'", "resolver");

            _mvcSpecificDependencyResolver = new AutofacDependencyResolver(incomingRebelResolver.AutofacContainer);
