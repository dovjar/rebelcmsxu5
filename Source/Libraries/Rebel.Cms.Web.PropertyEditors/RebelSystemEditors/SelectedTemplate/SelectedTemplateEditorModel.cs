...
namespace Rebel.Cms.Web.PropertyEditors.RebelSystemEditors.SelectedTemplate
{
    /// <summary>
    /// Represents the editor for the Selected Template in the content editor
    /// </summary>
    [Bind(Exclude = "AvailableTemplates")]
    [EmbeddedView("Rebel.Cms.Web.PropertyEditors.RebelSystemEditors.SelectedTemplate.Views.SelectedTemplateEditor.cshtml", "Rebel.Cms.Web.PropertyEditors")]
