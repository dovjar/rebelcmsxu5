...
namespace Rebel.Cms.Web.PropertyEditors.TreeNodePicker
{
    ...
    public class TreeNodePickerPreValueModel : PreValueModel
    {
        ...
        /// The available trees.
        /// </value>
        [Display(Name = "Tree type", Description = "TreePicker.SelectedTree.Description")]
        [EmbeddedView("Rebel.Cms.Web.PropertyEditors.TreeNodePicker.Views.TreeTypeDropDown.cshtml", "Rebel.Cms.Web.PropertyEditors")]
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IEnumerable<SelectListItem> GetAvailableTrees()
        {
            return _trees.Where(x =>
                    ...
                    x.Metadata.Id == new Guid(CorePluginConstants.MemberTreeControllerId))
