...
(function ($) {
    ...
    Rebel.PropertyEditors.RTEPreValueEditor = function() {
        ...
        var rtePreValueViewModel = {
            ...
            toggleAdvanced: function() {
                if (this.showAdvanced()) {
                    ...
                    var val = $("#rtePreValueEditor textarea[name$='.ValidElements']").text();
                    if (!_opts.showAdvanced && val == defaults) {
                        $("#rtePreValueEditor textarea[name$='.ValidElements']").text("");
                    }
                    ...
                    if (!_opts.showAdvanced && val == "") {
                        $("#rtePreValueEditor textarea[name$='.ValidElements']").text(defaults);
                    }
