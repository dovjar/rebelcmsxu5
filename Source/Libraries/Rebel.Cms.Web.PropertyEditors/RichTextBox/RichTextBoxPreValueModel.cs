...
using Rebel.Cms.Web.PropertyEditors.RichTextBox.Resources;
...
namespace Rebel.Cms.Web.PropertyEditors.RichTextBox
{
    ...
    [EmbeddedView("Rebel.Cms.Web.PropertyEditors.RichTextBox.Views.PreValueEditor.cshtml", "Rebel.Cms.Web.PropertyEditors")]
    public class RichTextBoxPreValueModel : PreValueModel
    {
        private readonly IRebelApplicationContext _appContext;

        public RichTextBoxPreValueModel(IRebelApplicationContext appContext)
        {
        ...
        /// The size.
        /// </value>
        [EmbeddedView("Rebel.Cms.Web.PropertyEditors.RichTextBox.Views.SizeInputField.cshtml", "Rebel.Cms.Web.PropertyEditors")]        
        ...
        /// The features.
        /// </value>
        [EmbeddedView("Rebel.Cms.Web.PropertyEditors.RichTextBox.Views.FeaturesCheckboxList.cshtml", "Rebel.Cms.Web.PropertyEditors")]
        ...
        /// The stylesheets.
        /// </value>
        [EmbeddedView("Rebel.Cms.Web.PropertyEditors.RichTextBox.Views.StylesheetsCheckboxList.cshtml", "Rebel.Cms.Web.PropertyEditors")]
        ...
        public IEnumerable<SelectListItem> GetStylesheets()
        {
            ...
            {
                var stylesheet = uow.Repositories.GetAll<Rebel.Framework.Persistence.Model.IO.File>();
        ...
        public override string GetSerializedValue()
        {
            ...
            if (!CustomPlugins.IsNullOrWhiteSpace())
            {
                xml.Add(new XElement("preValue", new XAttribute("name", "customPlugins"), new XCData(CustomPlugins.Trim(',', ' '))));
            }
        ...
        public override void SetModelValues(string serializedVal)
        {
            ...
            if (!string.IsNullOrEmpty(serializedVal))
            {
                ...
                CustomPlugins = (string)xml.Elements("preValue").Where(x => (string)x.Attribute("name") == "customPlugins").SingleOrDefault();
