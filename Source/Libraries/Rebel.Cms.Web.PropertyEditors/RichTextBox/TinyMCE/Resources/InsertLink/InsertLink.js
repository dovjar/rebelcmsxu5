...
(function ($) {
    ...
    Rebel.Controls.TinyMCE.InsertLink = function() {
        ...
        function setAllAttribs(elm) {
	        ...
	        if (viewModel.localUrl()) {
	            ...
	            dom.setAttrib(elm, 'data-rebel-link', 'internal');
	        } else {
	            dom.setAttrib(elm, 'data-rebel-link', '');
	        }
        ...
        return {
            init: function(o) {
                ...
                $("#tabs").rebelTabs({
                    ...
                    onTabChange: function (data) {
                        if (data.activeIndex == 0 && !contentTreeInitialized) {
                            $("#content-tree").rebelTreeApi().createJsTree();
                            contentTreeInitialized = true;
                        } else if (data.activeIndex == 1 && !mediaTreeInitialized) {
                            $("#media-tree").rebelTreeApi().createJsTree();
	            ...
	            if (el != null && el.nodeName == "A") {
	                ...
	                // TODO: Check for data-rebel-link attribute
	                var flag = ed.dom.getAttrib(el, 'data-rebel-link');
	                if(flag == 'internal') {
