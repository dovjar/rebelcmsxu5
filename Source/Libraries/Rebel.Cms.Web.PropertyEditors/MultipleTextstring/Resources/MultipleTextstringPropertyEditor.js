...
/// <reference path="/Areas/Rebel/Scripts/Rebel.Rebel.System/UrlEncoder.js" />
...
(function ($, Base) {
    ...
    Rebel.PropertyEditors.MultipleTextstringPropertyEditor = Base.extend({
        ...
        viewModel: {
            ...
            addRow: function (idx) {
                ...
                $("#" + this.rebelPropertyId + " li input[type=text]:eq(" + idx + ")").focus();
            }
        },
        ...
        init: function (o) {
            ...
            this.viewModel.rebelPropertyId = o.rebelPropertyId;

            var textstrings = $("#" + o.rebelPropertyId +"_Value").val().split("\n");
            ...
            $("#" + o.rebelPropertyId + " li input[type=text]").live("keydown", function(e) {
                ...
                if(keyCode == 40) { // Down arrow
                    var input = $("#" + _this.viewModel.rebelPropertyId + " li:eq(" + Math.min(idx + 1, _this.viewModel.textstrings().length - 1) + ") input[type=text]").get(0);
                    _this._focusInput(input);
                    flag = true;
                }
                if(keyCode == 38) { // Up arrow
                    var input = $("#" + _this.viewModel.rebelPropertyId + " li:eq(" + Math.max(idx - 1, 0) + ") input[type=text]").get(0);
                    _this._focusInput(input);
                    flag = true;
                }
            ...
            ko.applyBindings(this.viewModel, $("#"+ this.viewModel.rebelPropertyId).get(0));
        }
        ...
        getInstance: function () {
            if(this._instance == null)
                this._instance = new Rebel.PropertyEditors.MultipleTextstringPropertyEditor();
