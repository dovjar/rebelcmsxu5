...
(function ($) {
    ...
    Rebel.PropertyEditors.TextBoxPropertyEditor = function() {
        ...
        return {
			...
			charLimit: function (_opts) {
				...
				// TODO: i18n/L10n
				var _status = $('<div id="' + _opts.rebelPropertyId + '_Status" class="text-box-status">You have ' + (_limit - _field.val().length) + ' characters left.</div>');
            ...
            init: function(_opts) {
                var _this = this;
                var propertyEditor = new Rebel.PropertyEditors.PropertyEditor(_opts.rebelPropertyId);
                Rebel.PropertyEditors.PropertyEditorManager.getInstance().registerPropertyEditor(propertyEditor, function (ctx) {
                    ...
                    $("#" + _opts.rebelPropertyId + " textarea").mousedown(function (e) {
                        Rebel.PropertyEditors.PropertyEditorManager.getInstance().setFocus(e, propertyEditor);
                    })
                });
            },
