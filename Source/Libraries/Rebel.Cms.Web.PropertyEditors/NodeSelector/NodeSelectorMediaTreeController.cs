...
namespace Rebel.Cms.Web.PropertyEditors.NodeSelector
{
    ...
    /// </summary>
    [NodeSelectorCompatible(typeof(NodeSelectorMediaTreeController))]
    [Tree(FixedTreeIds.NodeSelectorMediaTreeId, "Media")]
    public class NodeSelectorMediaTreeController : MediaTreeController, INodeSelectorDataSource
    {
        ...
        {
            return _helper.GetTreeData(parentId, queryStrings, ActualRootNodeId, NodeCollection, CreateRootNode, RebelTree, base.GetTreeData);
        }
