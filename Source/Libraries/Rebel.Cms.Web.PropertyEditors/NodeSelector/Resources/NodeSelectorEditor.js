...
(function ($, Base) {
    ...
    Rebel.PropertyEditors.NodeSelector = Base.extend({
        //private
        ...
        _itemModelFromNode: function ($n) {
            ...
            var hiveId = new Rebel.System.HiveId($n.data().jsonId);
            var model = {
        ...
        _setupModelFromInitVals: function (initVals) {
            ...
            for (var i in initVals) {
                var hiveId = new Rebel.System.HiveId(initVals[i].nodeId);
                var model = {
            ...
            this._viewModel = $.extend({}, Rebel.System.BaseViewModel, {
                ...
                syncTree: function (item) {
                    ...
                    $.post(_this._opts.getPathUrl, data, function (e) {
                        ...
                        var treeApi = _this._el.find(".left .jstree-rebel").rebelTreeApi();
    ...
    $.fn.nodeSelector = function (opts) {
        ...
        return this.each(function () {
            var ns = new Rebel.PropertyEditors.NodeSelector($(this), opts);
        });
    };
