...
");
            sb.AppendLine("namespace Umbraco.Cms.Web.PropertyEditors.NodeSelector.CompiledScripts {");
            sb.Append("public class ");
            sb.Append(virtualPathId);//the class name will be NS + the virtual path id used (which is alphanumeric so should work)
            sb.Append(" : Umbraco.Cms.Web.PropertyEditors.NodeSelector.AbstractStartNodeQuery {");
            sb.AppendLine("");
...
");
            ...
            sb.Append("public class ");
            sb.Append(virtualPathId);//the class name will be NS + the virtual path id used (which is alphanumeric so should work)
            sb.Append(" : Umbraco.Cms.Web.PropertyEditors.NodeSelector.AbstractNodeFilter {");
            sb.AppendLine("");
