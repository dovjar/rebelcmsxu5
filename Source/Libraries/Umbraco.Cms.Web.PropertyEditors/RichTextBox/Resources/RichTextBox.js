...
(function ($) {
    ...
    Umbraco.PropertyEditors.RichTextBox = function($elem, o) {
        ...
        var _opts = $.extend({
                ...
                buttons: "newdocument,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,umbracostyles,styleselect,formatselect,fontselect,fontsizeselect,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,umbracolink,link,unlink,umbracoanchor,anchor,image,cleanup,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor,|,tablecontrols,table,|,hr,removeformat,visualaid,|,sub,sup,|,umbracocharmap,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen,|,insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,pagebreak,|,umbracomacro,umbracomedia",
