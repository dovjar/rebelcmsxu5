...
namespace Umbraco.Cms.Web.Mvc.ControllerFactories
{
    ...
    {
        public PluginControllerFactory(IUmbracoApplicationContext applicationContext)
        {
        ...
        /// andthe  route values contains both the 'Namespaces' and 'umbraco' data tokens in its route values.
        /// </summary>
        ...
        public bool CanHandle(RequestContext request)
        {
            ...
            return request.RouteData.DataTokens.TryGetValue("Namespaces", out namespaceToken)
                   && request.RouteData.DataTokens.TryGetValue("umbraco", out umbracoToken);
        }
