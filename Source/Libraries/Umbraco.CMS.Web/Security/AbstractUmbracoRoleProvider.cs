...
{
    public abstract class AbstractUmbracoRoleProvider<TUserType> : RoleProvider
        where TUserType : Profile, IMembershipUser, new()
    {
        ...
        /// The app context.
        /// </value>
        public IUmbracoApplicationContext AppContext { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractUmbracoRoleProvider"/> class.
        /// </summary>
        protected AbstractUmbracoRoleProvider()
        {
