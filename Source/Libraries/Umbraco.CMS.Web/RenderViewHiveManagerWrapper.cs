        ...
        private static void CheckRecycleBinTooLarge(HiveId[] descendantsOfRecycleBin)
        {
            ...
            if (descendantsOfRecycleBin.Length > 1000)
            {
                throw new InvalidOperationException(
                    "There are more than 1000 items (including descendants) in the Recycle Bin. Queries that don't specify a parent can't run unless there are fewer than 1000 items in the recycle bin; please consider emptying it in the Umbraco backoffice");
            }
        }
