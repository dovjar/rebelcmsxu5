...
namespace Rebel.Framework.Persistence.Examine
{
    /// <summary>
    /// Custom indexer for Rebel
    /// </summary>
    public class RebelExamineIndexer : LuceneIndexer
    {
        /// <summary>
        ...
        /// </param>
        public RebelExamineIndexer(IEnumerable<IndexSet> indexSetConfig)
            : base(indexSetConfig)
        {
        }
        ...
        public RebelExamineIndexer(DirectoryInfo workingFolder, Analyzer analyzer, SynchronizationType synchronizationType)
        ...
        public RebelExamineIndexer(Analyzer analyzer, SynchronizationType synchronizationType, Lucene.Net.Store.Directory luceneDirectory)
            : base(analyzer, synchronizationType, luceneDirectory)
        {
        }

        /// <summary>
        /// A type that defines the type of index for each Rebel field (non user defined fields)
        /// Alot of standard rebel fields shouldn't be tokenized or even indexed, just stored into lucene
