...
//[assembly: WebResource("RebelCms.Cms.Packaging.Editors.Resources.Packaging.css", "text/css", PerformSubstitution = true)]
//[assembly: WebResource("RebelCms.Cms.Packaging.Editors.Resources.PackagingInstaller.js", "application/x-javascript")]
//[assembly: WebResource("RebelCms.Cms.Packaging.Editors.Resources.AppRestarter.js", "application/x-javascript")]
...
namespace RebelCms.Cms.Web.Editors
{
    ...
    public class PackagingEditorController : DashboardEditorController
    {
        ...
        public JsonResult PerformRecycleApplication(bool onlyCheck)
        {
            if (!onlyCheck)
            {
                RebelCmsApplicationContext.RestartApplicationPool(HttpContext);
        ...
        public ActionResult RunPackageActions(string id, PackageInstallationState state)
        {
            ...
            if (nugetPackage != null)
            {
                ...
                if (User.Identity is RebelCmsBackOfficeIdentity)
                {
                    var user = (RebelCmsBackOfficeIdentity)User.Identity;
                    var userId = user.Id;
                    ...
                    using (var uow = BackOfficeRequestContext.Application.Hive.OpenReader<ISecurityStore>())
                    {
                        ...
                        HttpContext.CreateRebelCmsAuthTicket(entity);
                    }
                }
            }
