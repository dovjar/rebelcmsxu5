...
namespace RebelCms.Cms.Web.Editors
{
        ...
        where TEditorModel : StandardContentEditorModel
    {
        ...
        [Save]
        [RebelCmsAuthorize(Permissions = new[] { FixedPermissionIds.Create }, IdParameterName = "ParentId")]
        [SupportsPathGeneration]
        ...
        [RebelCmsAuthorize(Permissions = new[] { FixedPermissionIds.Save })]
        ...
        [RebelCmsAuthorize(Permissions = new[] { FixedPermissionIds.Unpublish })]
