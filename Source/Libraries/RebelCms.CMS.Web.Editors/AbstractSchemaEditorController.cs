        ...
        where TCreateModel : CreateContentModel, new()
    {
        ...
        public virtual ActionResult CreateNewForm(TCreateModel createModel)
        {
            ...
            using (var uow = Hive.Create<IContentStore>())
            {
                ...
                model.Alias = createModel.Name.ToRebelCmsAlias();
        ...
        private void ProcessCreatingTab(TEditorModel model)
        {
            ...
            if (ValueProvider.GetValue("submit.Tab") != null)
            {
                ...
                else if (model.DefinedTabs.Select(x => x.Alias).Contains(model.NewTabName.ToRebelCmsAlias()))
                {
                ...
                else
                {
                    ...
                    model.DefinedTabs.Add(
                        new Tab
                            {
                                Alias = model.NewTabName.ToRebelCmsAlias(),
        ...
        protected virtual void EnsureSelectListData(TEditorModel model)
        {
            ...
            model.IconsBaseUrl = BackOfficeRequestContext.Application.Settings.RebelCmsFolders.DocTypeIconFolder;
            model.ThumbnailsBaseUrl = BackOfficeRequestContext.Application.Settings.RebelCmsFolders.DocTypeThumbnailFolder;

            model.SpriteFileUrls = BackOfficeRequestContext.DocumentTypeIconResolver.Sprites.Select(x =>
                BackOfficeRequestContext.Application.Settings.RebelCmsFolders.DocTypeIconFolder + "/" + x.Value.Name);
        ...
        {
            ViewBag.ControllerId = RebelCmsController.GetControllerId<EditorAttribute>(GetType());
            ...
            using (var uow = Hive.Create<IContentStore>())
            {
                ...
                ViewBag.DocTypeThumbnailBaseUrl = Url.Content(BackOfficeRequestContext.Application.Settings.RebelCmsFolders.DocTypeThumbnailFolder);
            }
