...
namespace RebelCms.Cms.Web.Editors
{
    ...
    public class StylesheetEditorController : AbstractFileEditorController
    {
        ...
        public ActionResult EditRule(HiveId id)
        {
            ...
            {
                var stylesheet = uow.Repositories.Get<RebelCms.Framework.Persistence.Model.IO.File>(new HiveId(stylesheetId));
        ...
        public ActionResult EditRule(StylesheetRuleEditorModel ruleModel)
        {
            ...
            using (var uow = _hive.Create())
            {
                ...
                var stylesheet = repo.Get<RebelCms.Framework.Persistence.Model.IO.File>(ruleModel.ParentId);
        ...
        public ActionResult DeleteRule(HiveId id)
        {
            ...
            {
                var repo = uow.Repositories;
                var stylesheet = repo.Get<RebelCms.Framework.Persistence.Model.IO.File>(new HiveId(stylesheetId));
