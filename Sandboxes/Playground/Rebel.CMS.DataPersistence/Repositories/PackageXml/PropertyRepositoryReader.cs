...
namespace Rebel.CMS.DataPersistence.Repositories.PackageXml
{
    /// <summary>
    /// This class is responsible for resolving AttributeDefinitions (DocTypeProperties) from the Rebel package XML
    /// </summary>
