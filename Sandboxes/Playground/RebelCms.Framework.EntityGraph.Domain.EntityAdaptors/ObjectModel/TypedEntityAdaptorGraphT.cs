...
namespace RebelCms.Framework.EntityGraph.Domain.EntityAdaptors.ObjectModel
{
    /// <summary>
    /// Represents a simple 1-dimensional keyed collection of entities
    /// </summary>
    /// <typeparam name="TAllowedType"></typeparam>
    public class TypedEntityAdaptorGraph<T> : KeyedCollection<IMappedIdentifier, T>, ITypedEntityGraph<T> where T : ITypedEntityVertex
    {
        ...
        protected override IMappedIdentifier GetKeyForItem(T item)
        {
            return item.Id;
        }
        ...
        public void Add(KeyValuePair<IMappedIdentifier, T> item)
        {
            base.Add(item.Value);
        }
        ...
        public bool Contains(KeyValuePair<IMappedIdentifier, T> item)
        {
        ...
        public void CopyTo(KeyValuePair<IMappedIdentifier, T>[] array, int arrayIndex)
        {
        ...
        public bool Remove(KeyValuePair<IMappedIdentifier, T> item)
        {
        ...
        public void Add(IMappedIdentifier key, T value)
        {
        ...
        public bool TryGetValue(IMappedIdentifier key, out T value)
        {
        ...
        public T this[IMappedIdentifier key]
        {
            get { return this[key]; }
            set { this[key] = value; }
        }
        ...
        public IEnumerator<KeyValuePair<IMappedIdentifier, T>> GetEnumerator()
        {
